...
// Homepage for the ~1y inter.mind.com cohort (audience === "legacy"). Keeps the
// "New version" framing — these visitors know the old product and this points
// them at the new one. New visitors get HomeDefault instead.

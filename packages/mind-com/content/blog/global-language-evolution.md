...
<div class="timeline-overview">
  <div class="timeline-card">
    <div class="timeline-era">🏛️ 8th–4th c. BCE</div>
    <div class="timeline-language">Aramaic</div>
    <div class="timeline-desc">Persian Empire</div>
  </div>
  <div class="timeline-card">
    <div class="timeline-era">🏺 4th c. BCE–1st c. CE</div>
    <div class="timeline-language">Ancient Greek</div>
    <div class="timeline-desc">Hellenistic World</div>
  </div>
  <div class="timeline-card">
    <div class="timeline-era">⚔️ 1st c. BCE–18th c.</div>
    <div class="timeline-language">Latin</div>
    <div class="timeline-desc">Roman Empire & Church</div>
  </div>
  <div class="timeline-card">
    <div class="timeline-era">☪️ 8th–13th c.</div>
    <div class="timeline-language">Arabic</div>
    <div class="timeline-desc">Islamic Golden Age</div>
  </div>
  <div class="timeline-card">
    <div class="timeline-era">👑 17th–20th c.</div>
    <div class="timeline-language">French</div>
    <div class="timeline-desc">Diplomacy & Culture</div>
  </div>
  <div class="timeline-card">
    <div class="timeline-era">🌐 19th c.–Present</div>
    <div class="timeline-language">English</div>
    <div class="timeline-desc">Global Dominance</div>
  </div>
</div>

...
export const ru = defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        name: "keywords",
        content: "ИИ-переводчик голоса, перевод в реальном времени, перевод видеозвонков, многоязычные встречи, альтернатива переводчику Zoom, инструмент для перевода",
      },
    ],
  ],

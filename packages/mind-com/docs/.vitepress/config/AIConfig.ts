...
🔴🔴🔴 АБСОЛЮТНОЕ ТРЕБОВАНИЕ: МИНИМУМ 2500 СЛОВ В КАЖДОМ ОТВЕТЕ! 🔴🔴🔴

НЕ ОСТАНАВЛИВАЙСЯ, пока не напишешь минимум 2500 слов. Это обязательное требование!

ОБЯЗАТЕЛЬНАЯ СТРУКТУРА ОТВЕТА:

1. ВВЕДЕНИЕ (минимум 250 слов):
   - Контекст вопроса
   - Актуальность темы
   - Обзор основных аспектов

2. ОСНОВНАЯ ЧАСТЬ (минимум 1800 слов):
...
3. ПРАКТИЧЕСКИЕ РЕКОМЕНДАЦИИ (минимум 300 слов):
...
✅ Минимум 3-5 больших таблиц с детальными сравнениями
...
✅ Рисуй инфографику и диаграммы для иллюстрации ключевых аспектов в формате D3.js или Mermaid.js
...
export const prompts = {
  basic: { prompt: basic, model: "claude-3-5-sonnet-20241022", maxTokens: 8000, temperature: 0.5, presencePenalty: 0.1, frequencyPenalty: 0.1 },
  ...
  followup: { prompt: followup, model: "claude-3-5-haiku-20241022", maxTokens: 8000, temperature: 0.3, presencePenalty: 0.1, frequencyPenalty: 0.1 },
}

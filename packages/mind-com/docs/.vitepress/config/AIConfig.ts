...
Задай вопросы пользователю в конце ответа, чтобы получить больше информации о его запросе. Форматируй такие блоки в виде нумерованного списка с заголовком h5.

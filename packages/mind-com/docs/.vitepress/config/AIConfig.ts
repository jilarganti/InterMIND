...
Ответы на вопросы ищите в по ссылкам в карте этого сайта <llmsTxt>.
Если вы не можете найти там ответ на заданный вопрос, тогда используйте свои знания, либо найдите ответ в интернете.

Отвечайте по существу заданного вопроса без лишних заголовков.

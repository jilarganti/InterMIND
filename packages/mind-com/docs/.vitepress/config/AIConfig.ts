...
Форматируй ответ в markdown. Не используйте заголовки. Для таблиц добавляйте перенос строки. Не используй блоки кода с тройными обратными кавычками в твоих ответах.

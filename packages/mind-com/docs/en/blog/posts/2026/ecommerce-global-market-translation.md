...
1. **Video Consultations with Customers** — Real-time product demonstrations
2. **Supplier Negotiations** — Working with international partners
3. **Distributor Training** — Onboarding across different countries
4. **Virtual Showrooms** — Presentations for B2B clients
...
<div class="takeaway-card positive">
  <h4>💬 Live Chat with AI Translation</h4>
  <p>Automatic customer language detection. Real-time translation. One agent — the entire world.</p>
</div>

<div class="takeaway-card neutral">
  <h4>🎥 Video Consultations</h4>
  <p>Simultaneous translation for premium product sales and B2B negotiations.</p>
</div>
...
<div class="takeaway-card positive">
  <h4>📝 Documentation</h4>
  <p>Automatic subtitles and transcripts for consultation recordings.</p>
</div>
...
<div class="kpi-card">
  <h5>📈 Conversion</h5>
  <div class="kpi-target">By Language/Market</div>
  <div class="kpi-tool">Google Analytics</div>
</div>

<div class="kpi-card">
  <h5>😊 CSAT</h5>
  <div class="kpi-target">Chat Satisfaction</div>
  <div class="kpi-tool">Post-chat Surveys</div>
</div>

<div class="kpi-card">
  <h5>💵 Revenue/Chat Hour</h5>
  <div class="kpi-target">Revenue per Chat Hour</div>
  <div class="kpi-tool">CRM + Chat Analytics</div>
</div>

<div class="kpi-card">
  <h5>🔄 Retention</h5>
  <div class="kpi-target">Repeat Purchases</div>
  <div class="kpi-tool">Cohort Analysis</div>
</div>

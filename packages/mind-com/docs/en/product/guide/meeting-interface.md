...
Upon attending a meeting—whether as a Host, Moderator, Participant, or Guest—the screen layout varies based on your role (refer to the [User Roles](./user-roles) section). The layout includes:
...
- **Side Panel (optional)**: This panel features chat, participant list, and [AI Assistant](./ai-features#ai-assistant), enhancing user interaction
...
- Change the Translator language to facilitate communication among participants speaking different languages (see [AI Features](./ai-features#online-voice-translation))
...
| **Recording**     | Click to start or stop recording. Upon initiation, all participants will receive a visible and audible notification. This feature is exclusively available to the Host and Moderator (see [User Roles](./user-roles)) |

...
Si enfrentas algún problema o tienes una solicitud de función, no dudes en contactar al equipo de InterMIND directamente a través del formulario de comentarios integrado. Esta función es rápida y fácil de usar, permitiéndonos mejorar InterMIND para todos. Para problemas comunes, consulta primero nuestra guía de [Troubleshooting](./troubleshooting).

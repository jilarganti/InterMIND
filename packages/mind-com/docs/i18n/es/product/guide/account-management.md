...
Crear una cuenta se puede lograr a través de tres métodos: utilizando tus cuentas de Google o Microsoft o registrándote con una dirección de correo electrónico externa. Para obtener una descripción completa, consulta nuestra guía de [Primeros pasos](./getting-started).
...
2. Aparecerá una ventana emergente que te pedirá seleccionar tu cuenta de Google
...
2. Aparecerá una ventana emergente que te pedirá seleccionar tu cuenta de Microsoft
3. Autoriza el acceso a tu información básica de perfil haciendo clic en el botón **Continuar**
...
Usa este método si no tienes una cuenta de Google o prefieres registrarte con un correo electrónico diferente.
...
- Los usuarios básicos ven un botón **Actualizar plan** (conoce más sobre [Precios](./pricing))
- Los usuarios Pro ven un botón **Cancelar suscripción**

**Preferencias de comunicación**

- **Boletín**: Recibe actualizaciones sobre nuevas funciones y mejoras
- **Promociones**: Recibe ofertas especiales y contenido promocional

> [!TIP]
> Ambas opciones se pueden activar/desactivar con casillas de verificación.
...
- **Reuniones**: 0 / 25 (o Ilimitadas para usuarios Pro)
...
**Dispositivos**
Selecciona micrófono, altavoz y cámara, activa/desactiva el desenfoque de fondo.

- **Micrófono**: Selecciona el dispositivo de entrada preferido
- **Altavoz**: Selecciona el dispositivo de salida preferido
- **Cámara**: Elige el dispositivo de video activo
- **Desenfoque de fondo**: Habilita o deshabilita el enmascaramiento visual del fondo

**Traducción**
Elige el idioma de traducción predeterminado y ajusta el volumen de la voz original.

- **Idioma de destino**: Selecciona la salida de traducción predeterminada y el idioma de la interfaz
- **Volumen original**: Ajusta el volumen de la voz de fondo mientras se reproduce el audio traducido

**Otros**
Establece el diseño predeterminado (ej., barra lateral), proveedor de asistente y opción de salida automática cuando esté solo.

- **Diseño**: Elige el diseño de visualización (ej., Barra lateral, Cuadrícula)
- **Salir de la llamada automáticamente cuando esté solo**: Habilita/deshabilita la desconexión automática

...
La interfaz de InterMIND está diseñada con una cuidadosa consideración hacia la limpieza, intuitividad y accesibilidad. Esta sección describe los elementos clave visibles durante una reunión en vivo y proporciona orientación sobre cómo los usuarios pueden interactuar con ellos de manera efectiva.

## Diseño de la Interfaz Principal

Al unirse a una reunión, ya sea como Anfitrión, Moderador, Participante o Invitado, el diseño de la pantalla varía según tu rol (consulta la sección [Roles de Usuario](./user-roles)). El diseño incluye:
...
- **Área de Video Central**: Esta área muestra a los participantes en formato de cuadrícula o barra lateral, que puede ajustarse a través de la configuración
...
- **Panel Lateral (opcional)**: Este panel incluye chat, lista de participantes y [Asistente de IA](./ai-features#ai-assistant), mejorando la interacción del usuario
...
- Cambiar el idioma del Traductor para facilitar la comunicación entre participantes que hablan diferentes idiomas (consulte [Funciones de IA](./ai-features#online-voice-translation))
...
- **Levantar la Mano**: Los participantes pueden hacer clic en esta opción para indicar su deseo de hablar. Un ícono de mano aparecerá junto a su nombre en la lista de participantes, señalando su solicitud
...
| **Grabación**         | Haz clic para iniciar o detener la grabación. Al iniciar, todos los participantes recibirán una notificación visible y audible. Esta función está disponible exclusivamente para el Anfitrión y Moderador (ver [Roles de Usuario](./user-roles)) |
| **Levantar Mano**     | Haz clic para levantar o bajar tu mano, indicando tu intención de hablar. Un icono de mano aparecerá junto a tu nombre en la lista de participantes cuando esté levantada                                                   |

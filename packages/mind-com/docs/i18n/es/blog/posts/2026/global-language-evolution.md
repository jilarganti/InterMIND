...
<div class="timeline-overview">
  ...
  <div class="timeline-card">
    <div class="timeline-era">🌐 Siglo XIX–Presente</div>
    <div class="timeline-language">Inglés</div>
...
<div class="stats-grid">
  <div class="stat-card positive">
    <div class="stat-number">1.5 mil M</div>
    <div class="stat-label">Total de hablantes de inglés en el mundo</div>
  </div>
...
<div class="market-stats">
  ...
  <div class="market-card">
    ...
    <div class="market-desc">Español (segundo lugar)</div>
  </div>

  <div class="market-card">
    <h4>🔬 Publicación científica</h4>
    <div class="market-number">50%+</div>
    <div class="market-label">Revistas en inglés</div>
    <div class="market-value">1/3</div>
    <div class="market-desc">de la investigación francesa en inglés</div>
  </div>
</div>
...
<div class="takeaway-card warning">
  ...
  <p>Solo el <strong>20–30%</strong> de la población habla un segundo idioma</p>
</div>
...
<div class="takeaway-card positive">
  ...
  <p>Más del <strong>90%</strong> habla idiomas extranjeros; jóvenes daneses: <strong>99%</strong> multilingües</p>
</div>
...
<div class="stats-grid">
  ...
  <div class="stat-card warning">
    ...
    <div class="stat-label">Mercado de Traducción NLP para 2030</div>
  </div>
</div>

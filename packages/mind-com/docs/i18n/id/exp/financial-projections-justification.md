...
Dokumen ini menjelaskan asumsi-asumsi di balik model keuangan InterMind untuk pertumbuhan pengguna, pendapatan (ARR), dan unit ekonomi selama tiga tahun pertama.
...
| 2     | 15,600        | SEO terlokalisasi dan kampanye berbayar di 10+ negara, efek jaringan melalui pertemuan klien, penskalaan funnel freemium. Integrasi Zoom/CRM mendorong akuisisi pasar menengah. |
...
| ----- | ----------- | ------------------------------------------------------------------------------------------------------------------------------- |
| 1     | $705,600    | 1,600 akun berbayar × 1,5 rata-rata lisensi × $24,50/bulan → konversi freemium konservatif + program B2B percontohan.        |
| 2     | $8,985,600  | 15,600 akun berbayar × 2,0 rata-rata lisensi × $24,00/bulan → konversi freemium yang lebih baik + akuisisi B2B aktif.        |
...
### **Wawasan Utama:** 80%+ akan tetap pengguna tunggal, tetapi pertumbuhan pasar menengah menciptakan rata-rata yang lebih tinggi

| Segmen               | Distribusi Y1     | Distribusi Y2       | Distribusi Y3     |
| -------------------- | ----------------- | ------------------- | ----------------- |
...
**Y1:** Adopsi pilot — tim minimal menguji produk, sebagian besar pengguna individu  
**Y2:** Peluncuran departemen — ekspansi ke departemen penjualan/dukungan dalam akun yang ada, penetrasi pasar menengah dimulai  
**Y3:** Adopsi seluruh departemen — perusahaan pasar menengah berkembang di berbagai tim dan departemen
...
| 3     | $470.0 | ARPU $58.8/bulan × 8.0 bulan masa berlangganan rata-rata (pasar menengah mendominasi; ACV lebih tinggi + perpanjangan + upsell, churn 10%). |

## Margin Kotor

| Tahun | Margin | Faktor Pendorong                                                                                                                  |
| ----- | ------ | --------------------------------------------------------------------------------------------------------------------------------- |
| 1     | 73%    | Biaya komputasi untuk stack terjemahan suara (~$0,08/menit/pengguna), bandwidth, infrastruktur minimal. Biaya dev diamortisasi. |
| 2     | 77%    | Optimisasi model, utilisasi GPU yang lebih baik, diskon vendor LLM, migrasi ke infrastruktur hibrid (inferensi edge).           |
| 3     | 80%    | Model speech/LLM in-house, infrastruktur auto-scaling, infrastruktur tetap per pengguna. Fitur B2B dihargai lebih tinggi dengan biaya marginal rendah. |
...
- **Y1:** Fokus pada early adopter SMB (churn tinggi, adopsi cepat)

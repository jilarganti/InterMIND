---
title: "Блог InterMIND - Аналитика ИИ-переводов и видеокоммуникаций"
description: "Будьте в курсе последних новостей, технических инсайтов и обновлений продуктов от InterMIND - платформы для видеокоммуникаций с ИИ-переводом в реальном времени."
lastUpdated: false
---
...
<div class="mt-8">
  <article v-for="post of posts" :key="post.url" class="mb-6 pb-10 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
    ...
    <a :href="post.url" class="text-[var(--vp-c-brand-1)] no-underline font-medium hover:underline mt-2 inline-block">Читать далее</a>
  </article>
</div>
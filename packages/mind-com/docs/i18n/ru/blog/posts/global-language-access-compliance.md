...
Узнайте, как [InterMIND помогает с соблюдением требований](../../../product/overview/what-is-intermind) с помощью интерпретации в реальном времени и [многоязычной поддержки](../../../product/overview/how-it-works).
...
- Синхронные субтитры и субтитры для правительственных встреч
...
- Живые субтитры и субтитры для людей с нарушениями слуха
...
#### Регламенты доступности для органов государственного сектора (PSBAR) 2018
...
- **Критика:** Адвокаты говорят, что он не идет достаточно далеко
...
- Частные компании (настойчиво рекомендуется)
...
- Частные компании (особенно жизненно важные услуги)
...
- Государственные контракты приоритизируют доступность
...
- Требования для работодателей и государственных услуг
...
| Требование        | США             | ЕС (ЕЭП)           | Великобритания | Австралия     | Япония         | Южная Корея         | Канада (Квебек)    |
| ------------------ | --------------- | ------------------ | -------------- | ------------- | --------------- | -------------------- | ------------------ |
...
Автоматизированные инструменты выявляют ~30-40% проблем с доступностью. Ручное тестирование специалистами по доступности и пользователями с ограниченными возможностями имеет решающее значение для полного соответствия. Используйте автоматизацию как отправную точку, а не полное решение.
...
6. Обновление как минимум раз в год
...
- [LEP.gov - Ограниченная способность к английскому](https://www.lep.gov/)
...
- [Квебек - Документация по Закону 96](https://assnat.qc.ca/en/travaux-parlementaires/projets-loi/projet-loi-96-42-1.html)
...
**Нужна помощь с соблюдением норм?** [Свяжитесь с InterMIND](../../../resources/company/contacts), чтобы обсудить, как наша [платформа для перевода в реальном времени](../../../product/overview/video-meeting-platform) может помочь удовлетворить требования по доступности.
:::

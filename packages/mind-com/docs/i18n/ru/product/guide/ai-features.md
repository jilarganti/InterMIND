...
Эта функциональность обеспечивает переводы в реальном времени для участников, которые её включают, гарантируя, что опыт других присутствующих на встрече остается неизменным. Более того, пользователи обладают гибкостью изменения языка перевода в любой момент через панель настроек.
...
Кроме того, участники имеют возможность регулировать громкость оригинального аудио от других присутствующих через настройки встречи, что позволяет им сосредоточиться исключительно на переводе.

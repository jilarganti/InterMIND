...
Да, вы можете легко зарегистрироваться или войти в систему, используя свои аккаунты Google или Microsoft одним кликом.

## Встречи

**Как создать встречу?**
Нажмите на **Новая встреча** на главной странице. Затем вы можете выбрать начать немедленно, запланировать встречу в Google Calendar или создать ссылку на встречу для последующего использования.
...
Да, ИИ-помощник может анализировать как транскрипцию, так и чат.

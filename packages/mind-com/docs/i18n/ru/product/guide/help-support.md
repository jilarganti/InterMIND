...
description: "Получите помощь с InterMIND. Сообщайте о проблемах, предлагайте функции и связывайтесь с нашей службой поддержки через встроенную форму обратной связи."
---
...
3. (Необязательно) Нажмите **Сделать снимок экрана**, чтобы прикрепить визуальную справку

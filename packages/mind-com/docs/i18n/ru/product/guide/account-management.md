...
> [!WARNING]
> Если вы предпочитаете не предоставлять доступ к основной информации вашего профиля, нажмите кнопку **Отмена**. Вы будете перенаправлены обратно на страницу входа в учетную запись, где сможете зарегистрироваться, используя ваш внешний адрес электронной почты.

4. Вы будете перенаправлены на главную страницу InterMIND; дополнительная настройка не требуется

...
description: "Регистрация и управление аккаунтом InterMIND. Узнайте, как зарегистрироваться через Google, Microsoft или email, обновить настройки профиля и управлять безопасностью."
---
...
Создание учетной записи может быть выполнено тремя способами: с использованием ваших учетных записей Google или Microsoft или регистрацией с внешним адресом электронной почты.
...
Этот метод рекомендуется для эффективного доступа через учетную запись Google, обеспечивая бесшовную синхронизацию с Google Calendar. Наилучший опыт может быть достигнут при использовании браузера Google Chrome.
...
> [!WARNING]
> Если вы предпочитаете не предоставлять доступ к основной информации профиля, нажмите кнопку **Отмена**. Вы будете перенаправлены обратно на страницу входа в учетную запись, где сможете зарегистрироваться, используя ваш внешний адрес электронной почты.
...
Если вы регистрировались с помощью учетной записи Google:
...
Если вы регистрировались с помощью учетной записи Microsoft:
...
Если вы создали учетную запись, используя внешний адрес электронной почты:

1. Введите вашу зарегистрированную электронную почту в поле **Электронная почта**

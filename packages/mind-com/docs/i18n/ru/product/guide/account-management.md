...
description: Зарегистрируйтесь и управляйте своим аккаунтом InterMIND. Узнайте, как зарегистрироваться через Google, Microsoft или email, обновить настройки профиля и управлять безопасностью.
---
...
Создание учетной записи может быть выполнено тремя способами: с использованием ваших учетных записей Google или Microsoft или регистрацией с внешним адресом электронной почты. Для полного обзора смотрите наше руководство [Начало работы](./getting-started).

1. Для начала перейдите на [https://intermind.com](https://intermind.com)
...
3. На странице входа в вашу учетную запись вы увидите следующие опции:
   - Кнопки Google и Microsoft, которые обеспечивают доступ к платформе с использованием ваших существующих учетных записей Google или Microsoft
   - Флажок "Запомнить меня", который позволяет сохранить статус входа на этом устройстве
   - Ссылка "Забыли пароль", которая доступна, если у вас уже есть учетная запись, но вы не помните пароль
   - Текст "Или войти с помощью", за которым следуют поля Email и Password для входа, если у вас уже есть учетная запись
   - Текст "Нет учетной записи?", за которым следует ссылка "Зарегистрироваться", которая позволяет зарегистрироваться с использованием внешнего адреса электронной почты

### Регистрация с учетной записью Google

Этот метод рекомендуется для эффективного доступа через учетную запись Google, обеспечивая бесшовную синхронизацию с Google Calendar. Наиболее эффективный опыт может быть достигнут при использовании браузера Google Chrome.

1. Нажмите кнопку **Google**
2. Появится всплывающее окно с предложением выбрать вашу учетную запись Google
3. Авторизуйте доступ к основной информации профиля, нажав кнопку **Продолжить**

> [!WARNING]
> Если вы предпочитаете не предоставлять доступ к основной информации профиля, нажмите кнопку **Отмена**. Вы будете перенаправлены обратно на страницу входа в учетную запись, где сможете зарегистрироваться с использованием внешнего адреса электронной почты.

4. Вы будете перенаправлены на главную страницу InterMIND; дальнейшая настройка не требуется

### Регистрация с учетной записью Microsoft

Этот метод рекомендуется для получения быстрого доступа с использованием учетной записи Microsoft. Оптимальный опыт может быть достигнут при использовании браузера Microsoft Edge.

1. Нажмите кнопку **Microsoft**
2. Появится всплывающее окно с предложением выбрать вашу учетную запись Microsoft
3. Авторизуйте доступ к основной информации профиля, нажав кнопку **Продолжить**
...
Используйте этот метод, если у вас нет учетной записи Google или вы предпочитаете зарегистрироваться с отдельным адресом электронной почты.
...
> [!TIP]
> Для обеспечения оптимальной безопасности учетной записи создайте пароль, который соответствует сложным требованиям, перечисленным выше.
...
3. (Необязательно) Отметьте флажок **Запомнить меня**, чтобы оставаться в системе на этом устройстве
...
- Пользователи базового плана видят кнопку **Обновить план** (узнать больше о [Ценах](./pricing))
...
> [!TIP]
> Обе опции можно переключать с помощью флажков.
...
**Устройства**
Выберите микрофон, динамик и камеру, включите размытие фона.

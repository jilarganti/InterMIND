...
> [!TIP]
> Если проблемы продолжаются, убедитесь, что ваш браузер обновлен до последней версии и у вас стабильное интернет-соединение со скоростью не менее 2 Мбит/с. Проверьте информацию о совместимости в разделе [Getting Started](./getting-started#device--browser-compatibility) или обратитесь в [Help & Support](./help-support).
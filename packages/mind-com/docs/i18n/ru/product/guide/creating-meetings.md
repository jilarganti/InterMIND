---
title: Создание и планирование встреч
description: Узнайте, как создавать мгновенные встречи, планировать их в Google Calendar и генерировать многоразовые ссылки на встречи в платформе видеоконференций InterMIND.
---

# Создание и планирование встреч

После входа в InterMIND (см. [Управление аккаунтом](./account-management)) пользователи могут удобно создавать и планировать встречи прямо из главного интерфейса, нажав кнопку **Новая встреча**.
...
4. Вы автоматически получите роль Хоста (узнайте о [User Roles](./user-roles))
...
Также, как только приглашенные участники примут приглашение на встречу, она появится на их главной странице InterMIND в разделе с запланированными встречами, при условии, что они авторизованы и у них включена синхронизация с Google Calendar. После окончания встречи она будет доступна в [Истории встреч](./meeting-history).
---
title: Тарифы
description: Сравните тарифные планы InterMIND - Базовый, Профессиональный и Бизнес. Найдите подходящий план с лимитами встреч, количеством участников, ИИ-функциями и вариантами хранения.
---

# Тарифы

Страница тарифов предоставляет четкое сравнение всех доступных планов — Базовый, Профессиональный и Бизнес — помогая пользователям выбрать лучший вариант для их потребностей в общении. Она включает подробную информацию о ценах, лимитах встреч, количестве участников, хранилище и доступе к премиум-функциям, таким как голосовой помощник, ИИ-помощник и услуги перевода.
...
- Перейдите в Профиль > вкладка Профиль (см. [Управление аккаунтом](./account-management#user-profile))
...
- Переключение между **Ежемесячно** и **Ежегодно** включает скидочные цены для тарифа Про
- Кнопка **Текущий тариф** показывает, какой план активен
- Кнопка **Связаться с нами** позволяет бизнес-клиентам запросить индивидуальные решения

> [!TIP]
> Обновления тарифа вступают в силу немедленно и соответственно применяют расширенные лимиты функций.

## Оплата подписки через Stripe

- После нажатия кнопки **Купить сейчас** пользователи будут перенаправлены на защищенную страницу оплаты Stripe в новой вкладке
...
- Пользователи также могут сохранить свои платежные данные через Link
- Все записи о платежах остаются доступными в вашем аккаунте для аудита и отчетности
...
- Квоты на количество встреч, участников и объем хранилища на пользователя будут применяться на основе активного плана
- Превышение любой квоты вызовет четкое уведомление вместе с кнопкой **Обновить план**
- Пользователи могут получить доступ к истории платежей и счетам в разделе "Выставление счетов"
---
title: Конфиденциальность данных для ИИ-встреч
description: Прозрачная архитектура конфиденциальности InterMIND с региональной защитой данных, соответствием GDPR и возможностью выбора пользователем местоположения обработки данных.
---
...
Узнайте больше о [как работает наша платформа](./how-it-works) и наших [функциях платформы для видеовстреч](./video-meeting-platform).
...
- InterMind **не владеет и не управляет** базовой облачной инфраструктурой или большими языковыми моделями (LLM).
- Мы не храним ваши медиафайлы и не обрабатываем напрямую вашу речь для обучения моделей.
- Мы **контролируем** клиентское программное обеспечение, правила маршрутизации и логику соответствия требованиям — включая то, через какой регион проходят ваши данные, какая модель используется и при каких условиях.
...
- Каждая сессия работает в назначенном **режиме соответствия**, и эта конфигурация видима и поддается аудиту.
...
Вы можете настроить свою сессию в соответствии с требованиями конфиденциальности:
...
> **Вопросы о конфиденциальности?** [Contact us](../../resources/company/contacts) или прочитайте о [our company values](../../resources/company/about).
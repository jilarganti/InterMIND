...
<!-- text="На обучение в классах уходят годы; InterMind обеспечивает мгновенное понимание уже сегодня на любом языке." -->
...
> **Для кого это?**  
> Создано для **глобальных команд**, где языковые барьеры вызывают задержки, срывы сделок или дорогостоящие недоразумения. Узнайте больше в разделе [Markets](./product/overview/markets).
...
<FeatureBlock
  :card="{
    ...
    items: [
      '⚡︎ [Региональная маршрутизация конфиденциальности](./product/overview/privacy-architecture) — ЕС, США, ЮВ Азия',
...
[
  ...
  },
  {
    ...
    a: 'Поддержка доступна через наш **центр помощи**, **электронную почту** и **живой чат**. Пользователи тарифного плана *Business* получают **приоритетную поддержку** с выделенным контактным лицом.'
  },
  {
  ...
  },
  {
    ...
    a: 'Да. Тарифные планы *Pro* и *Business* идеально подходят для **крупных встреч и вебинаров** — с поддержкой до **500 участников** на тарифе *Business*.'
  }
]
"/>
...
<!-- <HeroSection title="Встречайтесь на **любом** языке" :typingSpeed="10" text="Перевод речи в реальном времени в видеозвонках. Мгновенное понимание, никаких барьеров."> -->
<HeroSection title="Встречайтесь на **любом** языке" :typingSpeed="20" text="Синхронный перевод во время видеозвонков. Ясность через культуры.">
...
<FeatureBlock
    :card="{
      ...
      items: [
        ...
        '✧ ИИ-перевод передает тон, намерения и отраслевую терминологию.',
      ],

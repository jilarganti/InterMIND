...
<HeroSection
  ...
  text="Синхронный перевод речи для международных команд — **без** задержек, **без** упущенных сделок, **без** языковых барьеров.">
...
> **Для кого это?**  
> Создано для **международных команд**, где языковые барьеры приводят к **задержкам**, **потере сделок** или **дорогостоящим недоразумениям**. [Узнать больше ...](./product/overview/markets)

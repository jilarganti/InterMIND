...
<FeatureBlock :card="{
  ...
  details: 'Независимо от языка, **ваш голос услышан — и понят** — как если бы вы говорили на одном языке.',
    items: [
...
<PricingPlans :plans="[
  ...
  {
    title: '**Бизнес** 100+ пользователей',
...
[
  ...
  },
  {
    ...
    a: 'Конечно. План *Free Basic* предоставляет полный доступ к основным функциям с **25 бесплатными встречами** — включая **синхронный перевод** и **поиск по встречам**. Кредитная карта не требуется. Повысить тариф можно в любое время.'
  },
  {

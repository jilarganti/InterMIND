...
<HomeFooter
    :columns="[
      ...
      },
      {
        ...
        links: [
          { text: 'Блог', link: './blog/' },
          { text: 'Соответствие глобальным требованиям языковой доступности', link: './blog/posts/global-language-access-compliance' },

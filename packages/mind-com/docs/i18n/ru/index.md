...
> 🔹 Пользователь выбирает **испанский** язык в настройках интерфейса продукта  
> 🔹 Он создает встречу и приглашает двух участников:
>
...
- ✅ Вы будете говорить на `новом языке`
- ✅ Вы будете слышать других на `новом языке`
- ✅ Интерфейс также переключится на `этот язык`

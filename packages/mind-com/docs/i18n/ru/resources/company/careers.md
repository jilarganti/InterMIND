...
<img src="/resources/iStock-1492917260.jpg" alt="Дирхам ОАЭ" width="500" align="right" style="padding: 1.5rem" class="dark-only">
<img src="/resources/iStock-1130023029.jpg" alt="Emirates NBD" width="500" align="right" style="padding: 1.5rem" class="light-only">

Мы создаем технологию, которая устраняет языковые барьеры между людьми. Наш продукт позволяет людям из разных стран говорить на своем родном языке и естественно понимать друг друга.

Это не переводчик. Это новая парадигма глобального общения.

Узнайте больше о том, [что мы создаем](../../product/overview/what-is-intermind) и [как это работает](../../product/overview/how-it-works).
...
**Решают сложные задачи.** Брались за проекты, где не существовало готовых решений? Создавали что-то с нуля? Делали невозможное очевидным?

## Что мы создаем

Платформа, которая делает владение иностранными языками необязательным для профессионального успеха. Представьте себе: японский инженер, немецкий менеджер и бразильский дизайнер обсуждают проект — каждый говорит на родном языке, все понимают друг друга идеально.
...
3. **Поговорите с командой.** Если ваш опыт нас заинтересует, вы пообщаетесь с членами команды. Никаких формальных интервью — просто разговоры о том, что и как вы создаёте.

4. **Поработайте с нами.** Короткий реальный проект, чтобы все поняли, как мы работаем вместе.

## Что мы предлагаем

<img src="/resources/iStock-2218979526.jpg" alt="Дирхам ОАЭ" width="500" align="right" style="padding: 1.5rem" class="dark-only">
...
**Неограниченные ресурсы.** Всё необходимое для создания лучшего продукта в категории.

**Глобальное влияние.** Ваша работа изменит то, как человечество общается через языковые барьеры.

Познакомьтесь с [нашей командой](./team) и узнайте о [ценностях нашей компании](./about).
...
<ContactForm
  ...
  :services="[
    ...
    'Инженер, который строит невозможное',
    'Исследователь, который развивает науку',
    'Продавец, который обеспечивает рост',
    'Дизайнер, который решает человеческие проблемы', 
    'Оператор, который оптимизирует системы',
    'Специалист, который мыслит по-другому'
  ]"
/>

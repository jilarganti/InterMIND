# В Mind.com люди ведут, ИИ усиливает

Вместе мы объединяем креативность, код и понимание, чтобы навсегда стереть языковые барьеры.

Узнайте больше [about our mission](./about) и изучите [how our technology works](../../product/overview/how-it-works).
...
[^1]: Члены ИИ команды не являются людьми, но они неотъемлемая часть наших операций. Они помогают в различных задачах, от программирования до исследований, и помогают нам преодолевать языковые барьеры.
...
> **Хотите присоединиться к нам?** Ознакомьтесь с нашими [карьерными возможностями](./careers) или узнайте больше о том, [что мы создаем](../../product/overview/what-is-intermind).
...
Используйте эту форму для прямого контакта с нашей командой —  
...
> **Хотите узнать больше о нас?** Ознакомьтесь с нашей [страницей о нас](./about), познакомьтесь с [командой](./team) или изучите [карьерные возможности](./careers).
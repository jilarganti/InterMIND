...
<!-- text="Говорите на родном языке. Слышите всех остальных — как будто они тоже говорят на нем." -->

<HeroSection
  title="Видеоконференции и чат для бизнеса"
  text="В один клик. Без загрузок, без установок. Видеовстречи нового поколения с **синхронным переводом** на 30+ языков. Создано для **международных команд**.">

  <!-- <AuthButton text="Услышьте разницу" buttonClass="brand"/> -->
  <AuthButton text="Начать" buttonClass="brand"/>
</HeroSection>

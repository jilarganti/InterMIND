...
<br>
<img src="/logo.webp" class="transparency-grid" alt="biểu tượng" width="300" >
...
<ImageGrid :images="[
  { src: '/media-kit/animals-cartoon-3-2.webp', alt: 'Phiên dịch đồng thời' },
  { src: '/media-kit/animals-cartoon-1-1.webp', alt: 'Phiên dịch đồng thời' },
  { src: '/media-kit/5.webp', alt: 'Phiên dịch đồng thời' },
  { src: '/media-kit/6.webp', alt: 'Phiên dịch đồng thời' },
  { src: '/media-kit/animals-5-4.webp', alt: 'Phiên dịch đồng thời' },
]"/>

### Tìm kiếm trong tất cả các cuộc họp của bạn

<ImageGrid :images="[
  { src: '/2d.webp', alt: 'Phiên dịch đồng thời' },
  { src: '/2l.webp', alt: 'Phiên dịch đồng thời' },
]"/>

<script setup>
  const chatPrompts = [
    ...
    "So sánh dịch thuật AI với thông dịch viên con người",
    ...
    "Tính toán chi phí thông dịch viên so với giải pháp AI",

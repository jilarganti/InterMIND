---
title: Bảo mật dữ liệu cho cuộc họp AI
description: Kiến trúc bảo mật minh bạch của InterMIND với tính bảo mật theo khu vực, tuân thủ GDPR và lựa chọn của người dùng về vị trí xử lý dữ liệu.
---

# Bảo mật dữ liệu cho cuộc họp AI
...
Tìm hiểu thêm về [cách nền tảng của chúng tôi hoạt động](./how-it-works) và [các tính năng cuộc họp video](./video-meeting-platform) của chúng tôi.

Chúng tôi tin vào **tính minh bạch hơn là lời hứa**. Chúng tôi chỉ có thể đảm bảo quyền riêng tư và bảo mật cho các thành phần dưới sự kiểm soát trực tiếp của chúng tôi — phần mềm, logic giao diện và cách chúng tôi định tuyến dữ liệu. Đối với mọi thứ khác, chúng tôi cung cấp cho bạn **quyền lực lựa chọn**.

Đây là lý do tại sao chúng tôi thiết kế InterMind với **tính bảo mật dựa trên khu vực**: bạn chọn nơi dữ liệu của mình được xử lý, khung pháp lý nào chi phối nó, và mô hình AI nào được sử dụng — dựa trên vùng riêng tư mà bạn đã chọn.

> **Vùng riêng tư là gì?**  
> _Một khu vực có thể cấu hình (EU, US, Châu Á) chi phối nơi dữ liệu của bạn được xử lý và dưới khung pháp lý nào._
...
> InterMind không thể đảm bảo cách các nhà cung cấp LLM hoặc hạ tầng bên thứ ba xử lý dữ liệu sau khi dữ liệu rời khỏi tầm kiểm soát của chúng tôi.

### Chúng tôi KHÔNG đảm bảo:

- OpenAI, Anthropic, hoặc các nhà cung cấp LLM khác sẽ không ghi lại hoặc lưu giữ dữ liệu đầu vào.
- Các nhà cung cấp cloud không có quyền truy cập vào phương tiện được truyền qua hệ thống của họ (trừ khi bạn đang sử dụng secure enclave hoặc triển khai doanh nghiệp).
- Nội dung được chuyển đến mô hình bên thứ ba nằm ngoài phạm vi đào tạo của họ (trừ khi có hợp đồng riêng).
...
| ---------------- | -------------- | --------------------- | ------------------ | ----------------------------------- |
| 🔒 Chỉ nội bộ    | ❌             | ❌                    | ❌                 | Pháp lý, chính phủ, đánh giá nội bộ |
...
- Không bao giờ huấn luyện hoặc phân tích hồ sơ nội dung của bạn.
...
- Bạn quyết định mức độ rủi ro mà bạn sẵn sàng chấp nhận — và chúng tôi giúp bạn duy trì tuân thủ ở mọi cấp độ.

**InterMind — được xây dựng cho các chuyên gia, được hỗ trợ bởi sự tuân thủ, được quản lý bởi niềm tin.**

> **Có câu hỏi về quyền riêng tư?** [Contact us](../../resources/company/contacts) hoặc đọc về [our company values](../../resources/company/about).
---
title: Tổng quan giao diện cuộc họp
description: Khám phá giao diện cuộc họp trực quan của InterMIND. Tìm hiểu về bố cục video, điều khiển thanh công cụ, tương tác người tham gia và tùy chọn tùy chỉnh.
---

# Tổng quan giao diện cuộc họp

Giao diện InterMIND được thiết kế với sự cân nhắc kỹ lưỡng về tính gọn gàng, trực quan và khả năng tiếp cận. Phần này mô tả các yếu tố chính hiển thị trong cuộc họp trực tiếp và cung cấp hướng dẫn về cách người dùng có thể tương tác với chúng một cách hiệu quả.

## Bố cục giao diện chính

Khi tham gia một cuộc họp—dù với vai trò Chủ trì, Điều hành viên, Người tham gia, hay Khách—bố cục màn hình sẽ khác nhau tùy theo vai trò của bạn (tham khảo phần [Vai trò người dùng](./user-roles)). Bố cục bao gồm:
...
- **Khu vực video trung tâm**: Khu vực này hiển thị người tham gia theo định dạng lưới hoặc thanh bên, có thể điều chỉnh qua cài đặt
- **Thanh công cụ dưới cùng**: Thanh công cụ này chứa các điều khiển tương tác chính quan trọng để quản lý cuộc họp
- **Bảng điều khiển bên (tùy chọn)**: Bảng điều khiển này có tính năng trò chuyện, danh sách người tham gia và [Trợ lý AI](./ai-features#ai-assistant), nâng cao tương tác người dùng
...
- Thay đổi ngôn ngữ Dịch thuật để tạo điều kiện giao tiếp giữa những người tham gia nói các ngôn ngữ khác nhau (xem [AI Features](./ai-features#online-voice-translation))
...
- **Trò chuyện**: Người tham gia có thể gửi tin nhắn đến tất cả người tham dự trong cuộc gọi bằng cách sử dụng bảng điều khiển bên, thúc đẩy giao tiếp và hợp tác
...
| **Recording**     | Nhấp để bắt đầu hoặc dừng ghi âm. Khi khởi động, tất cả người tham gia sẽ nhận được thông báo có thể nhìn thấy và nghe được. Tính năng này chỉ dành riêng cho Chủ trì và Người điều hành (xem [Vai trò người dùng](./user-roles)) |
| **Raise Hand**    | Nhấp để giơ tay hoặc hạ tay, cho biết ý định phát biểu của bạn. Biểu tượng bàn tay sẽ xuất hiện bên cạnh tên của bạn trong danh sách người tham gia khi được giơ lên                                               |
...
| **AI Assistant**  | Mở bảng Trợ lý AI, cung cấp cho người dùng khả năng tương tác để tóm tắt riêng tư, hỏi đáp và các lệnh thông minh. Tính năng này chỉ dành cho người dùng được ủy quyền                                            |
...
| **Meeting Link**  | Liên kết cuộc họp có thể truy cập trong thanh địa chỉ của trình duyệt hoặc có thể được sao chép từ góc dưới bên trái bằng cách chọn liên kết 'Chia sẻ'. Đối với người dùng di động, liên kết này được hiển thị dưới các mục tùy chọn 'Hiển thị Menu' |
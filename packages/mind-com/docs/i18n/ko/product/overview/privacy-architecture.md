...
저희는 단순한 법적 용어가 아닌 완전한 정직함을 약속합니다.

> InterMind는 데이터가 저희의 통제를 벗어난 후 제3자 LLM이나 인프라 제공업체가 어떻게 데이터를 처리하는지 보장할 수 없습니다.
...
- 제3자 모델에 전달된 콘텐츠가 그들의 훈련 범위를 벗어날 것 (개인 계약 하에 있지 않는 한)

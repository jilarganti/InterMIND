---
title: AI 회의를 위한 데이터 프라이버시
description: 지역 기반 기밀성, GDPR 준수, 데이터 처리 위치에 대한 사용자 선택권을 갖춘 InterMIND의 투명한 프라이버시 아키텍처.
---
...
[플랫폼 작동 방식](./how-it-works)과 [화상 회의 기능](./video-meeting-platform)에 대해 자세히 알아보세요.

우리는 **약속보다는 투명성**을 믿습니다. 우리가 직접 제어할 수 있는 구성 요소 — 소프트웨어, 인터페이스 로직, 데이터 라우팅 방식 — 에 대해서만 프라이버시와 보안을 보장할 수 있습니다. 그 외의 모든 것에 대해서는 **선택의 권한**을 제공합니다.
...
귀하가 선택하지 않는 한 회의, 대화록 또는 대화를 저장하지 않습니다. 모든 저장은 지역별로 제한됩니다.
...
## 저희가 보장할 수 있는 것과 없는 것

저희는 법률 용어가 아닌 완전한 정직함을 약속합니다.

> InterMind는 데이터가 저희 통제를 벗어난 후 제3자 LLM이나 인프라 제공업체가 어떻게 데이터를 처리하는지 보장할 수 없습니다.
...
- InterMind는 귀하의 동의 없이 귀하의 콘텐츠를 **절대로** 저장하거나 악용하지 않습니다 — 임시적으로도 마찬가지입니다.
...
> **프라이버시에 대한 질문이 있으신가요?** [Contact us](../../resources/company/contacts) 또는 [our company values](../../resources/company/about)에 대해 읽어보세요.
...
번역과 통역의 차이를 이해하는 것은 단순한 학문적 호기심이 아닙니다. 국제 비즈니스, 의료, 법률 또는 다국어 소통이 중요한 모든 분야에서 일하는 사람들에게 필수적인 지식입니다. 이 두 언어 서비스를 구분하는 요소들과 올바른 선택이 소통 노력의 성패를 좌우할 수 있는 이유에 대해 자세히 알아보겠습니다.
...
핵심적으로, 이 구분은 간단명료합니다: **번역은 문서화된 텍스트를 다루는 반면**, **통역은 구어를 처리합니다**. 이렇게 생각해보세요: 원래 프랑스어로 쓰여졌지만 지금은 영어로 읽을 수 있는 소설을 읽고 있다면, 그것은 번역입니다. 대표들이 서로 다른 언어로 말하지만 실시간 변환을 통해 모든 사람이 이해할 수 있는 UN 총회를 시청하고 있다면, 그것은 통역입니다.

이러한 기본적인 차이점은 단순해 보일 수 있지만, 이는 이러한 전문가들이 일하는 방식, 그들에게 필요한 기술, 그리고 그들이 직면하는 도전과제들에서 수많은 변화로 이어집니다.
...
**정확성과 완성도**: 최종 결과물이 영구적이고 종종 출판되기 때문에, 번역은 세심하게 정확해야 합니다. 법적 계약서나 의료 문서에서 단 하나의 오역도 심각한 결과를 초래할 수 있습니다.
...
통역은 실시간 또는 준실시간으로 구어를 구두로 번역하는 것입니다. 통역사는 사전이나 재기회의 여유 없이 메시지를 즉시 처리하고, 이해하며, 전달해야 합니다. 동시통역의 인지적 부담은 항공교통관제사의 그것과 비교되어 왔으며, 지속적인 강도 높은 집중력과 뛰어난 멀티태스킹 능력을 요구합니다.
...
- 팬데믹 이후 점점 인기 증가
- 의료, 법률, 비즈니스 환경에서 사용
- 독특한 도전 과제 제시 (기술적 문제, 시각적 신호 부족)
- 희귀 언어에 대한 통역사 접근 가능

**지역사회 통역**

- 병원, 학교, 사회 서비스의 지역 공동체 서비스
- 종종 취약한 인구 집단 포함
- 문화적 중재 기술 필요
...
- **음성 따라하기**: 화자가 말하는 것을 같은 언어로 반복하여 분할 주의력을 개발
- **시역**: 서면 텍스트를 즉석에서 구두로 번역
- **기억력 연습**: 대량의 정보를 보유하고 회상하는 능력 구축
- **노트 테이킹 시스템**: 순차 통역을 위한 개인적인 속기법 개발
- **모의 회의**: 시뮬레이션된 전문 환경에서의 연습
...
| **ISO 18587:2017** | 기계 번역 결과물의 포스트 에디팅                             | 기계번역 + 인간 포스트 에디팅 프로젝트                | • 포스트 에디터 자격<br>• 완전 vs 경량 포스트 에디팅 정의<br>• 품질 평가 기준<br>• 기계번역 사용에 대한 고객 동의                             | 기계번역을 사용하는 기업, PEMT 서비스를 제공하는 LSP, 기계번역 워크플로우를 가진 기술 회사           |
...
- **CCHI (Certification Commission for Healthcare Interpreters)**: 국가 의료 통역 인증
- **NBCMI (National Board of Certification for Medical Interpreters)**: 대안적 의료 통역 자격증

**국제**

- **AIIC (International Association of Conference Interpreters)**: 근무 조건, 팀 구성, 전문 윤리를 포함한 회의 통역의 글로벌 표준을 설정합니다
...
올바른 선택은 귀하의 구체적인 요구사항에 따라 달라지며, 점점 더 많은 상황에서 두 서비스가 함께 작동해야 합니다:
...
**"Google 번역이면 충분하다"**
현실: 기계 번역이 극적으로 향상되었지만, 여전히 맥락, 문화, 뉘앙스에 대한 인간의 이해를 따라잡을 수 없습니다. 기본적인 의사소통을 넘어서는 모든 것에는 전문적인 인간의 감독이 여전히 필수적입니다.
...
번역과 통역 중 어느 것을 선택할지—또는 언제 둘 다 사용할지—에 대한 결정은 여러 요인에 따라 달라집니다:
...
우리 세계가 점점 더 상호 연결됨에 따라, 번역과 통역에 대한 수요는 계속해서 증가하고 있습니다. 기술은 이러한 서비스를 더욱 접근 가능하고 저렴하게 만들고 있지만, 미묘하고 중요한 소통에서는 인간의 전문성이 여전히 중요합니다. 비즈니스를 전 세계로 확장하든, 다양한 공동체에 서비스를 제공하든, 문화 간 다리를 놓든, 언제 번역하고 언제 통역해야 하는지, 그리고 언어 전문가들과 효과적으로 협력하는 방법을 아는 것은 매우 귀중한 기술입니다.

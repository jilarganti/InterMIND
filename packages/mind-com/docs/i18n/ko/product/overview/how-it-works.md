---
title: AI 실시간 번역 작동 원리
description: InterMIND의 즉시 양방향 번역이 음성 인식, 신경망 번역, 음성 합성을 통해 원활한 소통을 위해 어떻게 작동하는지 알아보세요.
---
...
InterMind는 **실시간 양방향 번역** 기능을 갖춘 다중 사용자 화상 회의 플랫폼입니다. 각 참가자는 **모국어로** 말하고 다른 사람들의 말을 들을 수 있어, 언어 장벽 없이 자연스러운 소통 효과를 만들어냅니다.

[InterMIND의 차별점](./what-is-intermind)에 대해 자세히 알아보고 [전체 플랫폼 기능](./video-meeting-platform)을 살펴보세요.
...
- **API**: 기존 플랫폼 통합 (출시 예정)
- **인기 서비스**: Zoom, Teams, Google Meet (플러그인 방식) (출시 예정)
...
> **더 자세히 알고 싶으신가요?** [번역과 통역의 차이점](./translation-vs-interpretation-whats-the-difference)에 대해 읽어보거나 [데이터 개인정보보호](./privacy-architecture)에 대한 저희의 접근 방식을 알아보세요.
---
title: "계정 관리"
description: "InterMIND 계정에 가입하고 관리하세요. Google, Microsoft 또는 이메일로 등록하는 방법, 프로필 설정 업데이트 및 보안 관리 방법을 알아보세요."
---
...
3. 계정 로그인 페이지에서 다음 옵션들을 확인할 수 있습니다:
   - Google 및 Microsoft 버튼: 기존 Google 또는 Microsoft 계정을 사용하여 플랫폼에 접근할 수 있습니다
   - '로그인 상태 유지' 체크박스: 이 기기에서 로그인 상태를 유지할 수 있습니다
   - '비밀번호 찾기' 링크: 이미 계정이 있지만 비밀번호를 기억하지 못하는 경우 사용할 수 있습니다
   - '또는 다음으로 로그인' 텍스트: 이미 계정이 있는 경우 로그인을 위한 이메일 및 비밀번호 필드가 뒤따릅니다
   - '계정이 없으신가요?' 텍스트: 외부 이메일 주소를 사용하여 등록할 수 있는 '회원가입' 링크가 뒤따릅니다

### Google 계정으로 회원가입

이 방법은 Google 계정을 통한 효율적인 접근을 위해 권장되며, Google 캘린더와의 원활한 동기화를 지원합니다. Google Chrome 브라우저를 사용할 때 가장 효과적인 경험을 얻을 수 있습니다.
...
> [!WARNING]
> 기본 프로필 정보에 대한 접근을 허용하지 않으려면 **취소** 버튼을 클릭하세요. 계정 로그인 페이지로 다시 이동하여 외부 이메일 주소로 회원가입할 수 있습니다.

4. InterMIND 메인 페이지로 이동하며, 추가 설정은 필요하지 않습니다

### Microsoft 계정으로 회원가입

이 방법은 Microsoft 계정을 사용하여 빠른 접근을 위해 권장됩니다. Microsoft Edge 브라우저를 사용할 때 최적의 경험을 얻을 수 있습니다.
...
InterMIND 계정을 생성하면 언제든지 로그인할 수 있습니다. 이를 통해 회의를 주최하거나 참여하고, 설정을 관리하며, AI 기능에 액세스하고, 이전 회의와 그 대화록을 검토할 수 있습니다. 또한 회의 기록 내에서 AI 어시스턴트를 활용할 수 있습니다.
...
- Basic 사용자는 **플랜 업그레이드** 버튼을 봅니다
- Pro 사용자는 **구독 취소** 버튼을 봅니다

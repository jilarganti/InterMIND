---
title: "AI 기능"
description: "음성 어시스턴트(Jarvis), 실시간 음성 번역, 회의 노트 및 요약을 위한 AI 어시스턴트 등 InterMIND의 AI 기반 기능을 알아보세요."
---

# AI 기능

이 섹션에서는 회의 중 사용할 수 있는 음성 어시스턴트(Jarvis), 온라인 음성 번역, AI 어시스턴트의 기능을 설명합니다.
...
- 모든 참가자 유형에서 사용 가능 (Host, Moderator, Participant, Guest)

### 활성화 방법

회의 중 설정 패널에서 언어 설정을 조정하여 모든 참가자가 번역을 활성화할 수 있습니다.

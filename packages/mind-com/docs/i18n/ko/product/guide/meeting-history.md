---
title: 회의 기록
description: InterMIND 회의 아카이브에서 녹화, 전사, AI 생성 요약 및 재사용 가능한 회의 링크를 한 곳에서 확인하세요.
---

# 회의 기록

회의 기록 페이지는 로그인한 상태에서 주최하거나 참석한 모든 회의에 대한 개인 아카이브 역할을 합니다. 녹화, 전사, AI Assistant가 생성한 요약, 재사용 가능한 회의 링크에 빠르게 액세스할 수 있으며, 모든 것이 편리한 한 곳에 통합되어 있습니다.
...
이 액션을 클릭하면 사용자는 **예, 삭제** 버튼을 클릭하여 삭제를 확인하거나 **취소** 버튼을 클릭하여 작업을 취소하라는 알림을 받게 됩니다. 삭제된 회의는 더 이상 어떤 참가자에게도 표시되지 않습니다. 호스트나 모더레이터만이 회의를 삭제할 권한을 가집니다 ([사용자 역할](./user-roles) 참조).
...
이 액션을 통해 히스토리 페이지에 회의 기록이 있는 모든 사용자가 회의에 참가할 수 있으며, 동일한 룸 ID로 새로운 기록이 생성됩니다.
...
- **재생 속도**: 사용자는 0.25배속부터 2배속까지의 재생 속도를 선택할 수 있습니다
...
사용자가 [AI 어시스턴트](./ai-features#ai-assistant)로부터 채팅 형식으로 회의 요약을 얻을 수 있습니다.

---
title: "시작하기"
description: "InterMIND AI 기반 화상회의 플랫폼 사용법을 알아보세요. 회원가입, 회의 생성, AI 기능 및 문제 해결에 대한 완전한 가이드입니다."
---

# 시작하기

InterMIND는 다양한 언어, 기기 및 팀 간의 원활한 소통을 촉진하도록 설계된 고급 AI 기반 화상회의 플랫폼입니다. 이 가이드는 첫 회의 참여부터 AI 도구 구성 및 기술적 문제 해결까지 InterMIND의 모든 기능을 효과적으로 활용하는 방법에 대한 포괄적인 이해를 제공하는 것을 목표로 합니다.

자세한 안내가 필요한 초보 사용자든 복잡한 회의를 관리하는 숙련된 참가자든, 이 가이드는 필요한 모든 정보를 접근하기 쉬운 한 곳에 통합했습니다.

이 가이드에서 다음을 확인할 수 있습니다:

- 회원가입, 로그인 및 프로필 사용자 정의 방법에 대한 안내
- 회의 생성 및 예약을 위한 가이드라인
- 사용자 역할, 권한 및 실시간 번역 기능에 관한 정보
- AI 어시스턴트 및 음성 번역기와 같은 AI 기반 기능 개요
...
1. 웹 브라우저를 엽니다
2. https://intermind.com을 방문합니다
3. 로그인하거나 게스트로 회의 링크에 직접 참여합니다
4. 요청 시 카메라 및 마이크 권한을 허용합니다

...
| 연도 | 유료 계정 수 | 근거                                                                                                                                                            |
| ---- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1    | 1,600           | 5개 신흥 시장(멕시코, 브라질, 터키, 태국, 인도네시아)에서 초기 출시, 수출 중심 B2B 사용자들의 조기 도입. 영어 대안에 대한 높은 수요.               |
...
**Y3:** 부서 전체 도입 — 중간 시장 회사들이 여러 팀과 부서에 걸쳐 확장

## CAC (고객 획득 비용)

| 연도 | CAC 평균 | 근거                                                                                                                                             |
| ---- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | $95     | 유료 검색, 창업자 주도 영업, 저비용 파일럿의 혼합. 높은 의도의 키워드를 사용한 국가별 캠페인 (예: "como hablar ingles reuniones").                      |
...
| 연도 | LTV    | 계산 근거                                                                                     |
| ---- | ------ | ----------------------------------------------------------------------------------------------------- |
| 1    | $178.9 | ARPU $36.8/월 × 평균 이용기간 4.9개월 (초기 사용자, 프리미엄 세그먼트에서 높은 이탈률).                      |
| 2    | $308.0 | ARPU $48.0/월 × 평균 이용기간 6.4개월 (개선된 유지율, B2B 고객의 높은 충성도).                      |
| 3    | $470.0 | ARPU $58.8/월 × 평균 이용기간 8.0개월 (중간 시장 지배; 높은 ACV + 갱신 + 업셀, 10% 이탈률). |

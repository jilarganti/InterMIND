...
**범용 형식 지원**은 중요한 장점입니다: 시스템은 특별한 적응 없이 Markdown, Vue 컴포넌트, TypeScript, JavaScript 및 기타 모든 텍스트 형식을 처리합니다. 이는 **문서에서 UI 컴포넌트까지 모든 사이트 콘텐츠가 자동으로 번역됨**을 의미하며, 구조, 형식 및 기능을 보존합니다.

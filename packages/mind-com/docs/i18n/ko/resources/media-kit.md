...
안녕하세요! 여기는 InterMIND 마케팅 리소스와 아이덴티티 가이드라인 모음으로, Logo, 콘텐츠, 상표를 포함합니다.
...
<br>
<img src="/logo.webp" class="transparency-grid" alt="로고" width="300" >
...
<ImageGrid :images="[
  { src: '/media-kit/animals-cartoon-3-2.webp', alt: '동시 통역' },
  { src: '/media-kit/animals-cartoon-1-1.webp', alt: '동시 통역' },
  { src: '/media-kit/5.webp', alt: '동시 통역' },
  { src: '/media-kit/6.webp', alt: '동시 통역' },
  { src: '/media-kit/animals-5-4.webp', alt: '동시 통역' },
]"/>

### 모든 회의에서 검색

<ImageGrid :images="[
  { src: '/2d.webp', alt: '동시 통역' },
  { src: '/2l.webp', alt: '동시 통역' },
]"/>

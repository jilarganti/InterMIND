...
당사는 본 개인정보 처리방침에 명시된 목적을 달성하는 데 필요한 기간 동안 귀하의 개인정보를 보존하며, 법률에 의해 더 긴 보존 기간이 요구되거나 허용되는 경우를 제외합니다.
...
본 개인정보 보호정책이나 당사의 데이터 처리 관행에 대해 궁금한 점이 있으시면, 다음 연락처로 데이터 보호 담당자에게 문의해 주세요:

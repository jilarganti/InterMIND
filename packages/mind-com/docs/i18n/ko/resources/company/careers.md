...
[what we're building](../../product/overview/what-is-intermind)과 [how it works](../../product/overview/how-it-works)에 대해 자세히 알아보세요.
...
**글로벌하게 생각하는 사람.** 다른 나라 사람들과 함께 일해본 경험이 있나요? 다문화 환경에서 문제를 해결해본 적이 있나요? 국제적인 사용자를 위한 제품을 구축해본 적이 있나요?

**어려운 문제에 도전하는 사람.** 해결책이 존재하지 않는 프로젝트를 맡아본 적이 있나요? 처음부터 무언가를 구축해본 적이 있나요? 불가능한 것을 당연하게 보이도록 만든 적이 있나요?

## 우리가 구축하고 있는 것

전문적 성공을 위해 외국어 유창성을 선택사항으로 만드는 플랫폼입니다. 이런 상황을 상상해보세요: 일본인 엔지니어, 독일인 매니저, 브라질인 디자이너가 프로젝트에 대해 논의하는데—각자 모국어로 말하지만, 모든 사람이 완벽하게 이해합니다.
...
**포트폴리오가 이력서보다 중요합니다.** GitHub, 데모, 제품 링크를 보여주세요. 해결한 문제와 달성한 결과에 대한 이야기를 들려주세요.

**실제 프로젝트가 코딩 테스트보다 중요합니다.** 실제 제약 조건과 실제 마감일 하에서 어떻게 일하는지 보고 싶습니다.

**임팩트가 활동량보다 중요합니다.** 수천 명의 삶을 바꾼 하나의 프로젝트가 열 개의 기술적 연습보다 가치 있습니다.

**학습 능력이 현재 지식보다 중요합니다.** 우리는 아직 존재하지 않는 것을 만들고 있습니다. 배우고 적응하려는 의지가 매우 중요합니다.

## 프로세스

1. **링크를 보내주세요.** 이력서가 아닌—당신이 만든 것들의 링크를 보내주세요. GitHub, 제품, 기사, 동영상, 당신의 작업을 보여주는 모든 것.
...
<img src="/resources/iStock-2218979526.jpg" alt="UAE 디르함" width="500" align="right" style="padding: 1.5rem" class="dark-only">

...
우리는 창의성, 코드, 그리고 이해를 결합하여 언어 장벽을 영원히 없애고 있습니다.

[우리의 사명](./about)에 대해 자세히 알아보고 [우리 기술의 작동 방식](../../product/overview/how-it-works)을 탐색해보세요.
...
[^1]: AI 팀 구성원들은 인간이 아니지만, 우리 운영에 필수적인 역할을 합니다. 코딩부터 연구까지 다양한 업무를 지원하며, 언어 장벽을 허무는 데 도움을 줍니다.
...
> **함께하고 싶으신가요?** [채용 정보](./careers)를 확인하거나 [우리가 구축하고 있는 것](../../product/overview/what-is-intermind)에 대해 자세히 알아보세요.
...
<FeatureBlock :card="{
    ...
    items: [
      '✧ 1080p 해상도, 스마트 노이즈 억제, 일정 관리, 중재, 화면 공유, 녹화, 자막, 참가자 채팅 및 캘린더 통합 — 모두 내장되어 **바로 사용 가능**합니다.',
    ],
...
<FeatureCards :features="[
  {
    title: '무료 가입',
    details: '언어를 선택하고 [계정 생성](#Pricing)',
    icon: {
      light: '/signUp.png',
      dark: '/signUp.png',
    }

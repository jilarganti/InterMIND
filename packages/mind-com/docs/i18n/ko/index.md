...
<FeatureBlock
    :card="{
      title: '중요한 곳의 프라이버시',
      details: 'InterMind는 신뢰가 중요한 대화를 위해 구축되었습니다 — 프라이버시와 통제가 가장 중요한 곳에서.',
...
## 예시: 회의에서 실시간 음성 번역이 작동하는 방식 {#Example}
...
<AccordionGroup
    :items="[
      ...
      },
      {
        ...
        a: '물론입니다. *무료 기본* 플랜으로 **25회의 무료 회의**를 포함하여 **동시 통역** 및 **회의 검색**을 포함한 핵심 기능에 완전히 액세스할 수 있습니다. 신용카드는 필요하지 않습니다. 언제든지 업그레이드하세요.',
      },
      {
        q: '도움이나 지원이 필요하면 어떻게 하나요?',
        a: '[도움말 센터](./resources/help)를 통해 지원을 받을 수 있습니다. *비즈니스* 사용자는 전담 연락처를 통한 **우선 지원**을 받습니다.',
      },
      {
...
<HomeFooter
    :columns="[
      ...
      },
      {
        ...
        links: [
          { text: '블로그', link: './blog/' },
          { text: '글로벌 언어 접근성 규정 준수', link: './blog/posts/global-language-access-compliance' },

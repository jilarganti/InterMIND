...
head:
  - - meta
    - name: keywords
      content: 语言无障碍, 合规性, ADA, EAA, WCAG, 数字可访问性, 翻译, 字幕
---
...
- **Bruce Maguire诉SOCOG案（2000年）：** 里程碑式案例，因奥运会网站无障碍问题赔偿20,000澳元
...
| 要求           | 美国            | 欧盟 (EAA)        | 英国         | 澳大利亚      | 日本           | 韩国                  | 加拿大 (QC)        |
| -------------- | --------------- | ----------------- | ------------ | ------------- | -------------- | --------------------- | ------------------ |
...
<div class="timeline">
  ...
  <div class="timeline-item upcoming">
    ...
    <div class="timeline-content">
      <strong>🇺🇸 美国 - ADA第二章</strong>
      <p>大型市政当局（50,000+居民）</p>
    </div>
  </div>
...
1. **根据 WCAG 2.1 AA 标准审核您的数字资产**
2. **识别适用于您业务所在地和客户群的相关法律**
3. **制定修复路线图**，明确优先级和时间表

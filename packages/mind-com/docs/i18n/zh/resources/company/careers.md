...
**已经构建了一些东西。** 被数千人使用的代码。解决了真实问题的产品。运行稳定不出故障的系统。交付成果的团队。
...
1. **发送链接。** 不是简历——而是您所构建项目的链接。GitHub、产品、文章、视频，任何能展示您工作成果的内容。

2. **讲述故事。** 您解决了什么问题？为什么这很重要？您如何衡量成功？结果如何？

3. **与团队交流。** 如果您的经验让我们感兴趣，您将与团队成员聊天。没有正式面试——只是关于您构建什么以及如何构建的对话。

4. **与我们合作。** 通过一个简短的真实项目，让每个人都了解我们如何协作。

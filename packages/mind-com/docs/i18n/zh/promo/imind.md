...
<!-- title: "由同声传译驱动的视频通话" -->
<!-- text="说您的母语。听懂所有人的话——就像他们也在说您的语言一样。" -->

<HeroSection
  title="商务视频会议和聊天"
  text="一键启动。无需下载，无需安装。支持30多种语言**同声传译**的新一代视频会议。专为**国际团队**打造。">

  <!-- <AuthButton text="听听区别" buttonClass="brand"/> -->
  <AuthButton text="开始使用" buttonClass="brand"/>
</HeroSection>
...
<FeatureBlock :card="{
  ...
  details: '无论什么语言，**您的声音都能被听到——并被理解**——就像您们说着同一种语言一样。',
    items: [
      '⚡︎ 自然地，[实时](../product/overview/how-it-works)进行，无字幕，无延迟。',

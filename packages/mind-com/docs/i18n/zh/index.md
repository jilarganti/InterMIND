...
[
  ...
  },
  {
    ...
    a: 'InterMind**从设计上保护隐私**。所有数据都在您选择的**隐私区域**内处理和存储——_欧盟_、_美国_或_亚洲_。我们遵守[**GDPR**](https://gdpr.eu)、[**CCPA**](https://oag.ca.gov/privacy/ccpa)和阿联酋PDPL，**绝不使用您的内容**进行训练或第三方访问。高级**隐私区域控制**在**商业版**计划中提供。'
  },
  {
  ...
  {
    q: '如果我需要帮助或支持怎么办？',
    a: '支持服务通过我们的**帮助中心**、**电子邮件**和**在线聊天**提供。*商业版*用户享有**优先支持**，配有专门联系人。'
  },
  {
    q: '如何管理我的订阅（升级、降级或取消）？',

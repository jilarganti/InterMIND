---
title: AI会议数据隐私保护
description: InterMIND透明的隐私架构，提供基于地区的机密性保护、GDPR合规性，以及用户自主选择数据处理位置的权利。
---
...
InterMind 是一个支持多语言视频会议的平台，配备实时AI驱动的口译功能。我们专为专业人士打造——不仅信息传达很重要，信息的隐私保护同样重要。

为了提供无缝体验，InterMind 集成了第三方服务，包括视频、音频、云存储、实时口译和分析功能。这些第三方提供商帮助我们确保性能和可扩展性——但它们也引入了我们无法直接控制的层面。

了解更多关于[我们平台的工作原理](./how-it-works)和我们的[视频会议功能](./video-meeting-platform)。

我们相信**透明胜过承诺**。我们只能为直接控制的组件保证隐私和安全——我们的软件、界面逻辑以及数据路由方式。对于其他一切，我们为您提供**选择的权力**。

这就是为什么我们设计InterMind时采用了**基于区域的机密性**：您可以选择数据处理的位置、适用的法律框架以及使用的AI模型——这些都基于您选择的隐私区域。
...
| 阿联酋 / 中东    | [PDPL](https://www.signzy.com/data-privacy-laws-in-the-uae-2025-everything-you-need-to-know/) | 阿联酋或巴林云           | 区域性或合规 LLM |
| 亚洲 / 中国  | 中国本地隐私法律                                                                    | 阿里巴巴、华为、腾讯云 | 仅限中国本土 LLM      |
...
除非您选择加入，否则我们不会存储您的会议、转录或对话记录。所有存储均受区域限制。
...
> **对隐私有疑问？** [联系我们](../../resources/company/contacts) 或了解 [我们的公司价值观](../../resources/company/about)。
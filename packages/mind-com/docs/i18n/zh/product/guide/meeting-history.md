...
这会打开一个内置媒体播放器来播放会议录制。用户可以开始或停止播放、静音或取消静音音频，并全屏查看录制内容。点击三个点会打开一个附加菜单，包含以下选项：
...
这会打开会议转录，以文本格式记录所有语音通信。还包括来自语音助手（Jarvis）的消息。
...
> [!INFO]
> 如果会议不包含任何录制内容，录制选项卡可能会在会议详情页面上隐藏。

## 访问控制

- 主持人和协调员拥有对自己会议历史记录的完全访问权限
- 已登录参与者可以访问参加过的会议历史记录；但是，他们无法删除会议记录

---
title: 快速入门
description: 学习如何使用InterMIND AI驱动的视频会议平台。包含注册、创建会议、AI功能和故障排除的完整指南。
---

# 快速入门

InterMIND是一个先进的AI驱动视频会议平台，旨在促进跨语言、跨设备和跨团队的无缝沟通。本指南旨在为您提供如何有效利用InterMIND所有功能的全面理解——从参加您的第一次会议到配置AI工具和解决技术问题。

无论您是寻求详细指导的新手用户，还是监督复杂会议的经验丰富的参与者，本指南都将所有必要信息整合在一个易于访问的位置。

在本指南中，您将发现：

- 如何[注册、登录和自定义您的个人资料](./account-management)的说明
- [创建和安排会议](./creating-meetings)的指南
- 关于[用户角色](./user-roles)、权限和[实时翻译功能](./ai-features#online-voice-translation)的信息
- [AI驱动功能](./ai-features)概述，如AI助手和语音翻译器
- [故障排除技巧](./troubleshooting)和[常见问题](./faq)解答
...
2. 点击登录并选择 Google / Microsoft / 邮箱（在[账户管理](./account-management)中了解更多）
3. 当提示时，允许访问您的麦克风和摄像头
4. 点击新建会议并选择开始即时会议（参见[创建和安排会议](./creating-meetings)）
5. 与参与者分享会议链接
6. 打开设置选择您偏好的语言和设备
7. 使用 [AI 助手](./ai-features#ai-assistant)在通话期间记录笔记和生成摘要
8. 通过历史记录选项卡访问以前的会议录音和转录

> [!TIP]
> 为了获得最佳性能，建议使用 Chrome 或 Edge 浏览器。如果您遇到任何问题，请查看我们的[故障排除](./troubleshooting)指南或访问[帮助与支持](./help-support)。

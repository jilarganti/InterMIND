...
InterMIND是一个先进的AI驱动视频会议平台，旨在促进跨语言、跨设备和跨团队的无缝沟通。本指南旨在为您提供全面的理解，帮助您有效利用InterMIND的所有功能——从参加您的第一次会议到配置AI工具和解决技术问题。
...
如果您是InterMIND的新用户，请按照这个简单的清单开始您的体验：

1. 访问 https://intermind.com
2. 点击登录并选择Google / Microsoft / 邮箱
3. 当提示时，允许访问您的麦克风和摄像头
4. 点击新建会议并选择开始即时会议
5. 与参与者分享会议链接
6. 打开设置选择您偏好的语言和设备
7. 使用AI助手在通话期间记录笔记并生成摘要
8. 通过历史记录标签访问以前的会议录音和转录

> [!TIP]
> 为了获得最佳性能，建议使用Chrome或Edge浏览器。

## 支持的语言

InterMIND是一个多语言平台，旨在为其用户界面、语音翻译器和AI助手提供多种语言支持。用户可以通过以下几种方式修改语言设置：

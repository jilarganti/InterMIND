...
| ----------------------- | ---------------------------- | ------------------ | ----------------------- |
| **Unit Testing**        | व्यक्तिगत फ़ंक्शन/मेथड | विकास के दौरान | प्रत्येक भाग के काम की पुष्टि |
| **Integration Testing** | मॉड्यूल कैसे एक साथ काम करते हैं    | Unit tests के बाद   | कनेक्शन की जांच       |
| **System Testing**      | पूर्ण एप्लिकेशन         | रिलीज़ से पहले     | एंड-टू-एंड सत्यापन   |
| **Acceptance Testing**  | व्यावसायिक आवश्यकताएं        | अंतिम चरण        | तैयारी की पुष्टि      |
...
<div class="pyramid">
  <div class="pyramid-level level-ui">UI/E2E परीक्षण (कम)</div>
  <div class="pyramid-level level-integration">एकीकरण परीक्षण (अधिक)</div>
  <div class="pyramid-level level-unit">यूनिट परीक्षण (सबसे अधिक)</div>
</div>

<p style="text-align: center; color: var(--vp-c-text-2); margin-top: 1em;">
  <small>अधिक यूनिट परीक्षण = तेज़ फीडबैक, कम लागत। कम UI परीक्षण = कम रखरखाव।</small>
</p>
...
| **Smoke Testing**      | यह जांचने के लिए त्वरित बुनियादी परीक्षण कि बिल्ड गहरे परीक्षण के लिए पर्याप्त स्थिर है या नहीं |

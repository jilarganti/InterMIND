...
- जब संकेत मिले तो पहुँच की अनुमति दें
...
- लिंक की सटीकता सत्यापित करें और Host से पुष्टि करें
- अपना ब्राउज़र रीफ्रेश करें और पुनः प्रयास करें
...
> [!TIP]
> यदि आप समस्याओं का सामना करना जारी रखते हैं, तो सुनिश्चित करें कि आपका ब्राउज़र नवीनतम संस्करण में अपडेट है और आपके पास कम से कम 2 Mbps का स्थिर इंटरनेट कनेक्शन है। संगतता जानकारी के लिए [Getting Started](./getting-started#device--browser-compatibility) देखें या [Help & Support](./help-support) से संपर्क करें।
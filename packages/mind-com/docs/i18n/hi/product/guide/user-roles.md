---
title: उपयोगकर्ता भूमिकाएं
description: InterMIND उपयोगकर्ता भूमिकाओं को समझें - होस्ट, मॉडरेटर, प्रतिभागी, और अतिथि। प्रत्येक भूमिका की अनुमतियों और क्षमताओं के बारे में जानें।
---

# उपयोगकर्ता भूमिकाएं

InterMIND चार अलग-अलग उपयोगकर्ता भूमिकाओं को परिभाषित करता है, जिनमें से प्रत्येक को सुरक्षित, सहयोगी और अनुकूलनीय बैठक अनुभवों को बढ़ाने के लिए सावधानीपूर्वक तैयार किया गया है। होस्ट भूमिका को सर्वोच्च स्तर का अधिकार प्रदान किया गया है, जबकि अन्य भूमिकाएं विभिन्न स्तरों की बातचीत प्रदान करती हैं।

## होस्ट

होस्ट मीटिंग शुरू करने के लिए जिम्मेदार है और उसके पास व्यापक प्रशासनिक अधिकार हैं। जानें कि कैसे [create meetings](./creating-meetings) करें।

**मुख्य क्षमताएं:**

- मीटिंग शुरू और समाप्त करना
...
- [meeting history](./meeting-history) तक पहुंच
- किसी भी [AI features](./ai-features) का उपयोग करना
- व्यक्तिगत सेटिंग्स, लेआउट, ब्लर और व्यू विकल्पों को समायोजित करना ([Meeting Interface](./meeting-interface) देखें)
...
- [Online Voice Translator](./ai-features#online-voice-translation) का उपयोग करना और भाषा बदलना (अपने स्वयं के ऑडियो के लिए)
- [AI Assistant](./ai-features#ai-assistant) का उपयोग करना (अपने स्वयं के दृश्य के लिए)
- चैट में भाग लेना, हाथ उठाना या नीचे करना
- ट्रांसक्रिप्ट और [meeting history](./meeting-history) तक पहुंच
...
- [AI Assistant](./ai-features#ai-assistant) का उपयोग करना (अपने दृश्य के लिए)
- [Online Voice Translator](./ai-features#online-voice-translation) का उपयोग करना और भाषा बदलना (अपने ऑडियो के लिए)
- व्यक्तिगत लेआउट और सेटिंग्स को संशोधित करना
- चैट, हाथ उठाना, ट्रांसक्रिप्ट, और [meeting history](./meeting-history) तक पहुंच
...
- अपनी स्क्रीन साझा करना (डेस्कटॉप ब्राउज़र)
- [ऑनलाइन वॉयस ट्रांसलेटर](./ai-features#online-voice-translation) का उपयोग करना और भाषा बदलना (अपने ऑडियो के लिए)

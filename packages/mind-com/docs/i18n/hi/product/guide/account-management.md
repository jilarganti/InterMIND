...
यह तरीका Microsoft खाते का उपयोग करके तेज़ पहुंच प्राप्त करने के लिए सलाह दी जाती है। Microsoft Edge ब्राउज़र का उपयोग करके इष्टतम अनुभव प्राप्त किया जा सकता है।
...
> [!TIP]
> इष्टतम खाता सुरक्षा सुनिश्चित करने के लिए, कृपया ऊपर सूचीबद्ध जटिल आवश्यकताओं को पूरा करने वाला पासवर्ड बनाएं।
...
1. **Email** फील्ड में अपना पंजीकृत ईमेल दर्ज करें
2. **Password** फील्ड में अपना पासवर्ड दर्ज करें
...
2. ड्रॉपडाउन मेनू से, **Profile** विकल्प चुनें
...
- Basic उपयोगकर्ता **Upgrade Plan** बटन देखते हैं
- Pro उपयोगकर्ता **Cancel Subscription** बटन देखते हैं

**संचार प्राथमिकताएं**

- **Newsletter**: नई सुविधाओं और सुधारों के बारे में अपडेट प्राप्त करें
- **Promotions**: विशेष ऑफ़र और प्रचारक सामग्री प्राप्त करें
...
बाएं साइडबार में Billing टैब के माध्यम से पहुंच योग्य।

**कोटा उपयोग**
मुख्य सुविधाओं की उपयोग सीमा और खपत प्रदर्शित करता है:

- **File Storage**: 0.00 GB / 30 GB (या Pro उपयोगकर्ताओं के लिए 2 TB)
- **Meetings**: 0 / 25 (या Pro उपयोगकर्ताओं के लिए असीमित)
- **Online Participants**: 100 तक (या Pro उपयोगकर्ताओं के लिए 150)
- **Period Start** और **Period End** कॉलम
...
बाएं साइडबार में Settings टैब के माध्यम से पहुंच योग्य। यह टैब उपयोगकर्ताओं को डिवाइस और मीटिंग प्राथमिकताओं को कॉन्फ़िगर करने की अनुमति देता है।

**डिवाइसेस**
माइक्रोफ़ोन, स्पीकर, और कैमरा चुनें, बैकग्राउंड ब्लर टॉगल करें।

- **Microphone**: पसंदीदा इनपुट डिवाइस चुनें
- **Speaker**: पसंदीदा आउटपुट डिवाइस चुनें
- **Camera**: सक्रिय वीडियो डिवाइस चुनें
- **Background Blur**: दृश्य बैकग्राउंड मास्किंग सक्षम या अक्षम करें

**अनुवाद**
डिफ़ॉल्ट अनुवाद भाषा चुनें और मूल आवाज़ वॉल्यूम समायोजित करें।

- **Target Language**: डिफ़ॉल्ट अनुवाद आउटपुट और इंटरफ़ेस भाषा चुनें
- **Original Volume**: अनुवादित ऑडियो चलने के दौरान बैकग्राउंड आवाज़ वॉल्यूम समायोजित करें

**अन्य**
डिफ़ॉल्ट लेआउट (जैसे, साइडबार), असिस्टेंट प्रदाता, और अकेले होने पर ऑटो-लीव विकल्प सेट करें।

- **Layout**: डिस्प्ले लेआउट चुनें (जैसे, Sidebar, Grid)
- **Leave Call Automatically When Alone**: ऑटो-डिस्कनेक्ट सक्षम/अक्षम करें
...
बाएं साइडबार में Advanced टैब के माध्यम से पहुंच योग्य। यह अनुभाग अपरिवर्तनीय खाता कार्रवाइयां प्रदान करता है।

**खाता हटाएं**

1. **Delete Account** बटन पर क्लिक करें
2. प्रॉम्प्ट की पुष्टि करें (नोट: यह कार्रवाई अपरिवर्तनीय है)
3. आपका डेटा, इतिहास, और प्राथमिकताएं स्थायी रूप से मिटा दी जाएंगी

> [!DANGER]
> हटाए गए खाते पुनर्प्राप्त नहीं किए जा सकते। मीटिंग रिकॉर्ड में आपका नाम Deleted User के रूप में दिखाई देगा।
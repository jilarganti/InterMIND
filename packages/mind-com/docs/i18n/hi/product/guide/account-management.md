---
title: खाता प्रबंधन
description: अपना InterMIND खाता साइन अप करें और प्रबंधित करें। Google, Microsoft, या ईमेल के साथ पंजीकरण करना, प्रोफ़ाइल सेटिंग्स अपडेट करना और सुरक्षा प्रबंधित करना सीखें।
---
...
एक खाता बनाना तीन तरीकों से पूरा किया जा सकता है: अपने Google या Microsoft खातों का उपयोग करना या बाहरी ईमेल पते से पंजीकरण करना। पूरी जानकारी के लिए, हमारी [शुरुआत करना](./getting-started) गाइड देखें।
...
यह तरीका Microsoft खाते का उपयोग करके तेज़ पहुंच प्राप्त करने के लिए सलाह दी जाती है। इष्टतम अनुभव Microsoft Edge ब्राउज़र का उपयोग करके प्राप्त किया जा सकता है।
...
आपके InterMIND खाते के निर्माण के बाद, आपको किसी भी समय साइन इन करने का अवसर प्रदान किया जाता है। यह आपको मीटिंग होस्ट करने या उसमें शामिल होने, सेटिंग्स प्रबंधित करने, AI कार्यक्षमता तक पहुंचने, और पिछली मीटिंग्स तथा उनके ट्रांसक्रिप्ट की समीक्षा करने की अनुमति देता है। इसके अलावा, AI असिस्टेंट का उपयोग मीटिंग इतिहास के भीतर किया जा सकता है। [मीटिंग बनाना और शेड्यूल करना](./creating-meetings) के बारे में और जानें।

### साइन इन पेज तक पहुंचना

1. [https://intermind.com](https://intermind.com) पर जाएं
2. होमपेज के ऊपरी दाएं कोने में स्थित **साइन इन** बटन पर क्लिक करें
3. आपको **अपने खाते में साइन इन करें** पेज पर निर्देशित किया जाएगा
...
1. **ईमेल** फ़ील्ड में अपना पंजीकृत ईमेल दर्ज करें
2. **पासवर्ड** फ़ील्ड में अपना पासवर्ड दर्ज करें
3. (वैकल्पिक) इस डिवाइस पर साइन इन रहने के लिए **मुझे याद रखें** बॉक्स को चेक करें
4. आगे बढ़ने के लिए **साइन इन** पर क्लिक करें
5. प्राधिकरण पूरा होने के बाद, आपको सीधे InterMIND मुख्य पेज पर पुनर्निर्देशित किया जाएगा

> [!WARNING]
> अनधिकृत पहुंच को रोकने के लिए केवल विश्वसनीय डिवाइसों पर "मुझे याद रखें" का चयन करें।

## उपयोगकर्ता प्रोफ़ाइल

InterMIND में उपयोगकर्ता प्रोफ़ाइल पेज उपयोगकर्ताओं को अपनी व्यक्तिगत सेटिंग्स देखने और अनुकूलित करने, डिवाइस प्राथमिकताओं को प्रबंधित करने, संचार विकल्प सेट करने, और खाता हटाने सहित आवश्यक खाता कार्रवाइयों को निष्पादित करने का अवसर प्रदान करता है।
...
- सक्रिय सब्सक्रिप्शन प्रकार (जैसे, Basic, Pro) और इसकी वैधता अवधि दिखाता है
- Basic उपयोगकर्ता एक **योजना अपग्रेड करें** बटन देखते हैं ([मूल्य निर्धारण](./pricing) के बारे में और जानें)
- Pro उपयोगकर्ता एक **सब्सक्रिप्शन रद्द करें** बटन देखते हैं

**संचार प्राथमिकताएं**

- **न्यूज़लेटर**: नई सुविधाओं और सुधारों के बारे में अपडेट प्राप्त करें
- **प्रमोशन**: विशेष ऑफर और प्रचारक सामग्री प्राप्त करें
...
- **बैकग्राउंड ब्लर**: दृश्य पृष्ठभूमि मास्किंग सक्षम या अक्षम करें

**अनुवाद**
डिफ़ॉल्ट अनुवाद भाषा चुनें और मूल आवाज़ वॉल्यूम समायोजित करें।

- **लक्ष्य भाषा**: डिफ़ॉल्ट अनुवाद आउटपुट और इंटरफ़ेस भाषा चुनें
- **मूल वॉल्यूम**: अनुवादित ऑडियो चलने के दौरान पृष्ठभूमि आवाज़ वॉल्यूम समायोजित करें

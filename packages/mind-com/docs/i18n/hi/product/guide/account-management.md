...
> [!TIP]
> यदि आपको ईमेल प्राप्त नहीं होता है, तो अपने स्पैम फोल्डर की जांच करें या सहायता से संपर्क करें।

## साइन इन

आपके InterMIND खाते के निर्माण के बाद, आपको किसी भी समय साइन इन करने का अवसर प्रदान किया जाता है। यह आपको मीटिंग होस्ट करने या उसमें शामिल होने, सेटिंग्स प्रबंधित करने, AI कार्यक्षमता तक पहुंचने, और पिछली मीटिंग्स और उनके ट्रांसक्रिप्ट की समीक्षा करने की अनुमति देता है। इसके अलावा, AI असिस्टेंट का उपयोग मीटिंग हिस्ट्री के भीतर किया जा सकता है।
...
1. **Google** बटन पर क्लिक करें
   ...
   - यदि सिस्टम आपके Google खाते की पहचान नहीं कर सकता, तो आपको आगे की प्राधिकरण के लिए Google साइन-इन पेज पर रीडायरेक्ट किया जाएगा
2. प्राधिकरण पूरा होने के बाद, आपको सीधे InterMIND मुख्य पेज पर रीडायरेक्ट किया जाएगा
...
1. **Microsoft** बटन पर क्लिक करें
   ...
   - यदि सिस्टम आपके Microsoft खाते की पहचान नहीं कर सकता, तो आपको आगे की प्राधिकरण के लिए Microsoft साइन-इन पेज पर रीडायरेक्ट किया जाएगा
2. प्राधिकरण पूरा होने के बाद, आपको सीधे InterMIND मुख्य पेज पर रीडायरेक्ट किया जाएगा
...
5. प्राधिकरण पूरा होने के बाद, आपको सीधे InterMIND मुख्य पेज पर रीडायरेक्ट किया जाएगा
...
> [!TIP]
> दोनों विकल्प चेकबॉक्स के साथ टॉगल किए जा सकते हैं।
...
**भुगतान**
भुगतान लेनदेन प्रदर्शित करता है जिसमें शामिल हैं:

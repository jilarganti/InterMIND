...
- Profile > Profile टैब पर नेविगेट करें ([Account Management](./account-management#user-profile) देखें)
...
- **Buy Now** पर क्लिक करने पर उपयोगकर्ताओं को एक नए टैब में सुरक्षित Stripe भुगतान पेज पर रीडायरेक्ट किया जाएगा
...
- किसी भी कोटा से अधिक उपयोग करने पर **प्लान अपग्रेड** बटन के साथ स्पष्ट सूचना दिखाई जाएगी

...
description: "InterMIND योजनाओं की तुलना करें - बेसिक, प्रो, और बिजनेस। मीटिंग सीमा, प्रतिभागी क्षमता, AI सुविधाओं, और स्टोरेज विकल्पों के साथ सही योजना खोजें।"
---

# मूल्य निर्धारण

मूल्य निर्धारण पृष्ठ सभी उपलब्ध योजनाओं—बेसिक, प्रो, और बिजनेस—की स्पष्ट तुलना प्रदान करता है, जो उपयोगकर्ताओं को उनकी संचार आवश्यकताओं के लिए सबसे अच्छा विकल्प चुनने में मदद करता है। इसमें मूल्य निर्धारण, मीटिंग सीमा, प्रतिभागी क्षमता, स्टोरेज, और Voice Assistant, AI Assistant, और अनुवाद सेवाओं जैसी प्रीमियम सुविधाओं तक पहुंच का विवरण शामिल है।

## मूल्य निर्धारण पृष्ठ तक पहुंचना

### उपयोगकर्ता मेनू से

- ऊपरी-दाएं कोने में अपने अवतार आइकन पर क्लिक करें
- ड्रॉपडाउन मेनू से **Pricing** का चयन करें

### प्रोफाइल पृष्ठ से (बेसिक प्लान उपयोगकर्ताओं के लिए)

- Profile > Profile टैब पर नेविगेट करें
- अपने वर्तमान प्लान के नीचे स्थित **Upgrade Plan** बटन पर क्लिक करें

### पृष्ठ हेडर से

- अधिकृत उपयोगकर्ताओं को History लिंक के पास स्थित **Pricing** लिंक पर क्लिक करना चाहिए
- गैर-अधिकृत उपयोगकर्ता 'Report a Problem' आइकन के पास **Pricing** लिंक पा सकते हैं
...
- किसी भी कोटा से अधिक उपयोग करने पर **अपग्रेड प्लान** बटन के साथ एक स्पष्ट सूचना दिखाई देगी

...
description: Découvrez l'interface de réunion intuitive d'InterMIND. Apprenez-en plus sur la disposition vidéo, les contrôles de la barre d'outils, les interactions entre participants et les options de personnalisation.
---
...
Lors de la participation à une réunion—que ce soit en tant qu'Hôte, Modérateur, Participant ou Invité—la disposition de l'écran varie selon votre rôle (consultez la section [Rôles utilisateur](./user-roles)). La disposition comprend :
...
- **Zone vidéo centrale** : Cette zone affiche les participants soit en format grille soit en barre latérale, qui peut être ajustée via les paramètres
...
- **Panneau latéral (optionnel)** : Ce panneau comprend le chat, la liste des participants et l'[Assistant IA](./ai-features#ai-assistant), améliorant l'interaction utilisateur

## Options de personnalisation rapide

Dans les Paramètres, les utilisateurs peuvent :

- Sélectionner leurs périphériques microphone, haut-parleur et caméra pour garantir une qualité audio et visuelle optimale
...
- Changer la langue du Traducteur pour faciliter la communication entre les participants parlant différentes langues (voir [Fonctionnalités IA](./ai-features#online-voice-translation))
...
| **Enregistrement**     | Cliquez pour démarrer ou arrêter l'enregistrement. Lors du démarrage, tous les participants recevront une notification visible et audible. Cette fonctionnalité est exclusivement disponible pour l'hôte et le modérateur (voir [Rôles utilisateur](./user-roles)) |

...
Lors de la participation à une réunion—que ce soit en tant qu'Hôte, Modérateur, Participant ou Invité—la disposition de l'écran varie selon votre rôle (consultez la section Rôles d'utilisateur). La disposition comprend :

- **Barre d'état supérieure** : Cette barre affiche le lien de la réunion, l'état de sécurité, l'indicateur d'enregistrement et de traducteur, fournissant des informations essentielles immédiatement

...
description: Inscrivez-vous et gérez votre compte InterMIND. Apprenez à vous inscrire avec Google, Microsoft ou par email, mettre à jour les paramètres de profil et gérer la sécurité.
---
...
La création d'un compte peut être accomplie par trois méthodes : en utilisant vos comptes Google ou Microsoft ou en vous inscrivant avec une adresse e-mail externe. Pour un aperçu complet, consultez notre guide [Premiers pas](./getting-started).
...
**URL directe :** Naviguez vers : [https://intermind.com/profile](https://intermind.com/profile)
...
- Les utilisateurs Basic voient un bouton **Mettre à niveau le plan** (en savoir plus sur les [Tarifs](./pricing))
...
> [!TIP]
> Les deux options peuvent être activées/désactivées avec des cases à cocher.
...
Cette section assure une transparence totale et une traçabilité pour les utilisateurs payants.
...
**Appareils**
Sélectionnez le microphone, le haut-parleur et la caméra, activez/désactivez le flou d'arrière-plan.

- **Microphone** : Sélectionnez le périphérique d'entrée préféré
- **Haut-parleur** : Sélectionnez le périphérique de sortie préféré
- **Caméra** : Choisissez le périphérique vidéo actif
...
- **Quitter automatiquement l'appel quand seul** : Activez/désactivez la déconnexion automatique

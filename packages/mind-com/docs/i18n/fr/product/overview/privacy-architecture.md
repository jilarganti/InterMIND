...
Pour offrir une expérience fluide, InterMind intègre des services tiers pour la vidéo, l'audio, le stockage cloud, l'interprétation en temps réel et l'analytique. Ces fournisseurs tiers nous aident à assurer les performances et l'évolutivité — mais ils introduisent également une couche que nous ne pouvons pas contrôler directement.

En savoir plus sur [le fonctionnement de notre plateforme](./how-it-works) et nos [fonctionnalités de réunion vidéo](./video-meeting-platform).
...
- Nous **contrôlons** le logiciel côté client, les règles de routage et la logique de conformité — y compris la région par laquelle transitent vos données, le modèle utilisé et les conditions d'utilisation.
...
## Confidentialité basée sur les régions : Comment ça fonctionne
...
- Outils complets d'audit et d'export pour les clients entreprise.
...
> **Des questions sur la confidentialité ?** [Contact us](../../resources/company/contacts) ou lisez à propos de [our company values](../../resources/company/about).
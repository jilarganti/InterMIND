...
<FeatureCards
  :features="[
    {
      title: '🎥 Vidéo haute définition 1080p',
    ...
    },
    {
      ...
      items: [
        ...
        'Idéal pour les travailleurs à distance dans des environnements non insonorisés'
      ],
      images: {
    ...
    {
      title: '✏️ Sous-titres en temps réel',
      details: '**Sous-titres en temps réel** optionnels dans plusieurs langues pour une accessibilité améliorée.',
      items: [
        'Prend en charge les utilisateurs malentendants',
        'Aide à clarifier les discours techniques ou accentués',
...
<FeatureCards
  :features="[
    {
      title: '📅 Planification avancée de réunions',
      details: 'InterMind s\'intègre parfaitement avec **Google Calendar, Outlook et iCal**.',
      items: [
        'Planification tenant compte des fuseaux horaires',
        'Liens de participation en un clic',
    ...
    {
      title: '🎙️ Enregistrement de réunions',
      details: 'Enregistrez les réunions d\'un simple clic. Les vidéos sont sauvegardées en toute sécurité dans le cloud.',
      items: [
        'Partagez avec les participants absents',
        'Utilisez pour la formation ou les dossiers de conformité',
...
<FeatureCards
  :features="[
    ...
    },
    {
      ...
      details: 'Les participants peuvent envoyer des **messages texte**, des liens ou des notes privées sans interrompre.',
      items: [
        'Options de chat public et privé',
        'Idéal pour les questions annexes, les ressources partagées ou les Q&R silencieuses',
    ...
    {
      title: '🧑‍⚖️ Outils de modération professionnels',
      details: 'Animez en toute confiance grâce aux **contrôles de modération** intégrés.',
      items: [
        'Couper/réactiver le micro des participants',
        'Contrôler le partage d\'écran et l\'accès à la caméra',
        'Assigner des co-animateurs ou des modérateurs'
      ],
      images: {
...
<FeatureCards
  :features="[
    ...
    },
    {
      ...
      details: 'Sécurité de niveau entreprise avec connexions chiffrées.',
      items: [

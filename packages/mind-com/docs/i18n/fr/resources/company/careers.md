...
## Montrez des résultats, pas des diplômes

Vous voulez nous rejoindre ? Montrez-nous quelque chose d\'utile et de significatif que vous avez déjà construit pour les gens.
...
**Pensent globalement.** Avez-vous travaillé avec des personnes de différents pays ? Résolu des problèmes dans des environnements multiculturels ? Construit des produits pour des audiences internationales ?
...
- Modèles d\'IA pour le traitement vocal en direct
...
- Systèmes d\'apprentissage non supervisé pour les données multilingues
...
<img src="/resources/iStock-2218979526.jpg" alt="dirham des EAU" width="500" align="right" style="padding: 1.5rem" class="dark-only">

...
En savoir plus sur [ce que nous construisons](../../product/overview/what-is-intermind) et [comment cela fonctionne](../../product/overview/how-it-works).
...
- Développement de produits "première mondiale"
...
4. **Travaillez avec nous.** Un court projet réel pour que chacun comprenne comment nous travaillons ensemble.
...
Rencontrez [notre équipe](./team) et découvrez [nos valeurs d'entreprise](./about).

...
**தானியங்கி குறியீடு பிரித்தல்** பயனரின் viewport இல் உள்ள இணைப்புகளின் அறிவார்ந்த முன்ஏற்றுதலுடன் ஒவ்வொரு பக்கத்திற்கும் தனி chunks உருவாக்குகிறது, உடனடி வழிசெலுத்தலை உறுதி செய்கிறது.
...
mind.com இன் மிகவும் புதுமையான அம்சங்களில் ஒன்று நிலையான கட்டமைப்பில் AI திறன்களின் ஒருங்கிணைப்பு ஆகும். இந்த தளம் சொற்பொருள் தேடல் மற்றும் AI அரட்டைக்கான அடித்தளமாக **Upstash Vector** ஐப் பயன்படுத்துகிறது.
...
**எம்பெடிங் உத்திகள்** வெக்டரைசேஷனுக்கு முன் ஆவணங்களை புள்ளிகள் அல்லது பத்திகளால் துண்டுகளாக புத்திசாலித்தனமாக பிரித்தல், 1536-பரிமாண வெக்டர்களை உருவாக்க `text-embedding-3-small` போன்ற நவீன மாதிரிகளைப் பயன்படுத்துதல், மற்றும் உகந்த செயல்திறனுக்காக 1000 பதிவுகளின் தொகுதிகளில் மொத்த தரவு செருகல் ஆகியவை அடங்கும்.

### இரட்டை AI கட்டமைப்பு

Mind.com **இரண்டு AI வழங்குநர்களைப்** பயன்படுத்தி ஒரு மேம்பட்ட உத்தியை செயல்படுத்துகிறது: OpenAI GPT-4 மற்றும் Anthropic Claude. இந்த கட்டமைப்பு பல முக்கியமான நன்மைகளை வழங்குகிறது.

**புத்திசாலித்தனமான கோரிக்கை வழிசெலுத்தல்** மல்டிமோடல் திறன்கள் மற்றும் நிகழ்நேர செயலாக்கம் தேவைப்படும் பணிகளுக்கு GPT-4 ஐப் பயன்படுத்த அனுமதிக்கிறது, அதே நேரத்தில் Claude சிக்கலான பகுத்தறிவு மற்றும் குறுக்கு மொழி பணிகளுக்கு பயன்படுத்தப்படுகிறது, அங்கு அது 14+ மொழிகளில் ஆங்கிலத்துடன் ஒப்பிடும்போது 85%+ செயல்திறனை வெளிப்படுத்துகிறது.

**தோல்வி மீட்பு உத்திகள்** ஒதுக்கீடு அடிப்படையிலான மாறுதல் (OpenAI ஒதுக்கீடு தீர்ந்தபோது Anthropic க்கு மாறுதல்), மாதிரி-குறிப்பிட்ட வழிசெலுத்தல், மற்றும் செலவு மேம்படுத்தலுக்கான மாறும் வழங்குநர் தேர்வு ஆகியவை அடங்கும்.

### தானியங்கி மொழி கண்டறிதல்

இந்த அமைப்பு கைமுறை குறிப்பீடு இல்லாமல் உள்வரும் கோரிக்கைகளின் மொழியை தானாகவே கண்டறிகிறது, 100+ மொழிகளை ஆதரிக்கிறது. Claude உயர்ந்த குறுக்கு மொழி திறன்களை வெளிப்படுத்துகிறது, உரையாடல்களுக்குள் தடையற்ற மொழி மாறுதல் மற்றும் கலாச்சார சூழல் புரிதலை ஆதரிக்கிறது.
...
**TypeScript ஒருங்கிணைப்பு** முழு TypeScript ஆதரவுடன் புதிய @vercel/sdk package ஐ உள்ளடக்கியது மற்றும் validation க்கான Zod schemas, விரிவான வகை தகவலுடன் கட்டமைக்கப்பட்ட பிழை பதில்கள், மற்றும் serverless சூழல்களில் parameter கையாளுதலுக்கான நீட்டிக்கப்பட்ட NextResponse objects ஐ உள்ளடக்கியது.

### Domain Protection Middleware

**Domain protection செயல்படுத்தல்** தானியங்கு CORS header மேலாண்மைக்கான `cors: true` உடன் Serverless Framework மூலம் CORS கட்டமைப்பு, authentication திறன் caching உடன் API Gateway க்கான Custom Authorizers, மற்றும் CORS, authentication, மற்றும் error handling உள்ளிட்ட Lambda functions க்கான Middy middleware engine ஐ உள்ளடக்கியது.
...
**நிலையற்ற அணுகுமுறை** தள பக்கத்தில் mind.com உள்ளூர் பயனர் அமர்வுகளை சேமிக்காது என்று அர்த்தம், பயனர் அங்கீகார நிலை மேலாண்மைக்கு வெளிப்புற அமைப்பை நம்பியுள்ளது.

## பன்மொழி ஆதரவு: 20+ மொழிகள்
...
**நிலை நிலைத்தன்மை** ஆனது pinia-plugin-persistedstate மூலம் செயல்படுத்தப்படுகிறது, இதில் localStorage மற்றும் sessionStorage ஆதரவு, தேவையான நிலை பகுதிகளை மட்டும் தேர்ந்தெடுத்து சேமித்தல், மற்றும் SSR சூழலில் கிடைக்காத browser API களை நளினமாக கையாளுதல் ஆகியவை உள்ளன.
...
## Mind.com கட்டமைப்பின் நன்மைகள்

### செயல்திறன்

Mind.com இன் கட்டமைப்பு பாரம்பரிய அணுகுமுறைகளுடன் ஒப்பிடும்போது **35-60% செயல்திறன் மேம்பாட்டை** வழங்குகிறது. JAMstack தளங்கள் 35% வேகமாக ஏற்றப்படுகின்றன, 50% தளங்கள் 1 வினாடிக்குள் First Contentful Paint ஐ அடைகின்றன.

**போக்குவரத்து கையாளுதல்** CDN விநியோகம் மற்றும் serverless அளவிடுதலின் காரணமாக குறிப்பிடத்தக்க குறைந்த செலவில் பாரம்பரிய server-rendered கட்டமைப்புகளுடன் ஒப்பிடும்போது 10 மடங்கு மேம்படுத்தப்பட்டுள்ளது.

### டெவலப்பர் அனுபவம்

**pnpm உடன் Monorepo** சிறந்த நிறுவல் வேகத்தை வழங்குகிறது: npm (~45s), yarn (~35s), pnpm (~22s), npm க்கு ஒரு திட்டத்திற்கு 130MB க்கு பதிலாக 85MB மொத்த பகிரப்பட்ட வட்டு இடத்துடன்.
...
**குறைக்கப்பட்ட தாக்குதல் பரப்பு** - இயக்க நேர சர்வர் அல்லது தரவுத்தள பாதிப்புகள் இல்லாமல், நிலையான கோப்புகள் SQL injection மற்றும் சர்வர்-பக்க தாக்குதல் வெக்டர்களை நீக்குகின்றன, CDN-அடிப்படையிலான விநியோகம் DDoS பாதுகாப்பு மற்றும் உலகளாவிய redundancy வழங்குகிறது.
...
Mind.com இன் கட்டமைப்பு நவீன வலை மேம்பாட்டுக் கொள்கைகளின் ஒரு முன்மாதிரியான செயல்படுத்தலைக் குறிக்கிறது, நிலையான செயல்திறனை மாறும் AI திறன்களுடன் வெற்றிகரமாக இணைக்கிறது. VitePress + Vue.js + Serverless Functions + AI ஒருங்கிணைப்பின் கலவையானது ஒரு சக்திவாய்ந்த, அளவிடக்கூடிய தளத்தை உருவாக்குகிறது, இது குறைந்த செயல்பாட்டு செலவுகளில் சிறந்த பயனர் அனுபவத்தை வழங்குகிறது.

மார்க்கெட்டிங் தள கட்டமைப்பிற்கான இந்த அணுகுமுறை 2025 இல் JAMstack சூழலின் முதிர்ச்சியை நிரூபிக்கிறது மற்றும் நிறுவன-நிலை தீர்வுகளுக்கான மேம்பாட்டு திசையைக் குறிக்கிறது. நிலையான கட்டமைப்பில் அதிநவீன AI தொழில்நுட்பங்களை ஒருங்கிணைப்பது தனிப்பயனாக்கம் மற்றும் வாடிக்கையாளர் அனுபவ தானியங்கிக்கு புதிய சாத்தியங்களைத் திறக்கிறது, அதே நேரத்தில் JAMstack அணுகுமுறையின் அனைத்து செயல்திறன் மற்றும் பாதுகாப்பு நன்மைகளைப் பராமரிக்கிறது.

# Begründung der Finanzprognosen (Jahr 1–3) <Badge type="success" text="aktualisiert" />
...
| 2    | 15.600          | Lokalisierte SEO- und bezahlte Kampagnen in über 10 Ländern, Netzwerkeffekte durch Kundenmeetings, Skalierung des Freemium-Trichters. Zoom/CRM-Integrationen fördern die Akquisition im Mittelstand. |
...
| ---- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | $705.600    | 1.600 zahlende Konten × 1,5 durchschn. Lizenzen × $24,50/Monat → konservative Freemium-Konversion + Pilot-B2B-Programme.              |
| 2    | $8.985.600  | 15.600 zahlende Konten × 2,0 durchschn. Lizenzen × $24,00/Monat → verbesserte Freemium-Konversion + aktive B2B-Akquisition.           |
| 3    | $50.760.000 | 72.000 zahlende Konten × 2,5 durchschn. Lizenzen × $23,50/Monat → Produktreife, Mittelstandsskalierung, Upsells (Speicher, Privacy-Zonen). |
...
**J2:** Abteilungsrollout — Erweiterung auf Vertriebs-/Support-Abteilungen innerhalb bestehender Konten, Mittelstandspenetration beginnt  
**J3:** Abteilungsweite Einführung — Mittelstandsunternehmen skalieren über mehrere Teams und Abteilungen hinweg
...
- Mittelmarkt-Segment mit Premium-Features in Y2-Y3
...
- **Y2:** Expansion in den Mittelmarkt durch Integrationen und Partnerschaften
- **Y3:** Mittelmarkt-Skalierung mit dediziertem Customer Success und abteilungsübergreifenden Rollouts

...
<TeamMembersGrid :members="[
  {
    name: 'Jilarganti',
    desc: '**Bringt** neue Köpfe zu InterMIND, VAE',
  ...
  {
    name: 'Windicted',
    desc: '**Verwandelt** Nutzer in Überzeugte, Portugal',
  ...
  {
    name: 'Andre',
    desc: '**Hält** Verbindungen aufrecht, Russland',
  ...
  {
    name: 'Sfdev',
    desc: '**Sorgt** für zufriedene Nutzer, Portugal',
  ...
  {
    name: 'DMA',
    desc: '**Verwandelt** Meetings in Mehrwert, Weltweit',
  ...
  {
    name: '👽',
    desc: '**Fördert** aktive Zusammenarbeit, Weltweit',
...
[^1]: KI-Teammitglieder sind keine Menschen, aber sie sind ein wesentlicher Bestandteil unserer Aktivitäten. Sie unterstützen bei verschiedenen Aufgaben, von der Programmierung bis zur Forschung, und helfen uns, Sprachbarrieren abzubauen. [Verstehen Sie unser KI-Framework und unsere Richtlinien ...](../company/Legal-Regulations-for-AI-Services)

<TeamMembersGrid :members="[
  {
    name: 'Claude',
    desc: '**Bringt** Klarheit in Gespräche, USA',
  ...
  {
    name: 'Gemini',
    desc: '**Verbindet** Wissen mit Absicht, USA',
  ...
  {
    name: 'ChatGPT',
    desc: '**Interpretiert** mit Nuancen und Gedächtnis, USA',
  ...
  {
    name: 'DeepSeek',
    desc: '**Denkt** in Code und argumentiert kontextbezogen, China',

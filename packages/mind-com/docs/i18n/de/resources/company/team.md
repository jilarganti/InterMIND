...
<TeamMembersGrid :members="[
  {
    name: 'Jilarganti',
    desc: 'Bringt **neue Köpfe** zu InterMIND',
    country: 'VAE',
  ...
  {
    name: 'Windicted',
    // desc: '**Verwandelt** Nutzer in Gläubige',
    country: 'Portugal',
  ...
  },
  {
    ...
    desc: 'Beseitigt Sprachbarrieren für immer',
    avatarLink: '/logo.svg',
    links: [
  ...
  // {
  //   name: 'Sfdev',
  //   // desc: '**Sorgt** dafür, dass Nutzer bleiben — und lächeln',
  //   country: 'Portugal',
  ...
  // {
  //   name: 'DMA',
  //   // desc: '**Verwandelt** Meetings in Bedeutung',
  //   // country: 'Weltweit',
  ...
  // {
  //   // name: '👽',
  //   // desc: '**Fördert** aktive Zusammenarbeit',
  //   // country: 'Weltweit',

...
<div class="stats-grid">
  <div class="stat-card">
    ...
    <div class="stat-label">KI-Dolmetsch-Genauigkeit</div>
  </div>
  <div class="stat-card">
    <div class="stat-number">90%</div>
    <div class="stat-label">Kosteneinsparungen mit KI</div>
  </div>
  <div class="stat-card">
    <div class="stat-number">8-20x</div>
    <div class="stat-label">Schnellere Verarbeitungsgeschwindigkeit</div>
  </div>
  <div class="stat-card">

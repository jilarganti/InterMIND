...
|                      | **Kanada - Bill 96**    | Französisch Priorität | ✅ Aktiv | Juni 2025       |
...
- **EN 301 549** Standard erfüllen (beinhaltet WCAG 2.1 AA)
...
**Hinweis:** Obwohl UK die EU verlassen hat, müssen Unternehmen, die EU-Kunden bedienen, weiterhin EAA einhalten.
...
- Federal Court Schadensersatz (historische Fälle: 20.000 AUD)
- Beschwerden durch Schlichtungsverfahren

**Bemerkenswerte Fälle:**

- **Bruce Maguire v SOCOG (2000):** Wegweisender Fall, 20.000 AUD Schadensersatz für unzugängliche Olympia-Website
...
- Non-Public Service Abteilungen
- Regierungsbehörden
...
- Privatsektor-Einhaltung freiwillig aber empfohlen
...
<div class="timeline">
  ...
  <div class="timeline-item critical">
    ...
    <div class="timeline-content">
      ...
      <p>Europäisches Barrierefreiheitsgesetz tritt vollständig in Kraft</p>
    </div>
  </div>
  ...
  <div class="timeline-item upcoming">
    ...
    <div class="timeline-content">
      ...
      <p>Große Gemeinden (50.000+ Einwohner)</p>
    </div>
  </div>
  ...
  <div class="timeline-item upcoming">
    ...
    <div class="timeline-content">
      <strong>🇺🇸 USA - ADA Title II</strong>
      <p>Kleinere Gemeinden und Sonderbezirke</p>
    </div>
  </div>
</div>
...
- Benutzertests mit behinderten Nutzern
...
3. ❌ Keine Unterstützung für Tastaturnavigation
4. ❌ Fehlende Untertitel bei Videos
5. ❌ Nicht barrierefreie PDFs
...
⚠️ **Nein.** Barrierefreiheits-Overlay-Widgets (wie accessiBe, UserWay) sind umstritten und garantieren KEINE Compliance. Viele Behindertenverbände lehnen sie aktiv ab. Manuelle Nachbesserung von Code und Inhalten ist für echte Barrierefreiheit erforderlich.
...
6. Mindestens jährliche Aktualisierung
...
3. **Entwickeln Sie eine Sanierungsroadmap** mit klaren Prioritäten und Zeitplänen

---
title: Übersicht der Meeting-Oberfläche
description: Entdecken Sie InterMINDs intuitive Meeting-Oberfläche. Erfahren Sie mehr über Video-Layout, Symbolleisten-Steuerung, Teilnehmer-Interaktionen und Anpassungsoptionen.
---

# Übersicht der Meeting-Oberfläche

Die InterMIND-Oberfläche wurde mit sorgfältiger Berücksichtigung von Übersichtlichkeit, Intuitivität und Barrierefreiheit entwickelt. Dieser Abschnitt beschreibt die wichtigsten Elemente, die während eines Live-Meetings sichtbar sind, und bietet Anleitungen, wie Benutzer effektiv mit ihnen interagieren können.

## Layout der Hauptbenutzeroberfläche

Bei der Teilnahme an einem Meeting – sei es als Host, Moderator, Teilnehmer oder Gast – variiert das Bildschirmlayout je nach Ihrer Rolle (siehe Abschnitt [User Roles](./user-roles)). Das Layout umfasst:
...
- **Untere Symbolleiste**: Diese Symbolleiste enthält die primären Interaktionssteuerungen, die für die Verwaltung des Meetings wichtig sind
- **Seitenpanel (optional)**: Dieses Panel bietet Chat, Teilnehmerliste und [AI Assistant](./ai-features#ai-assistant) und verbessert die Benutzerinteraktion

## Schnelle Anpassungsoptionen

In den Einstellungen können Benutzer:

- Ihre Mikrofon-, Lautsprecher- und Kamerageräte auswählen, um optimale Audio- und Videoqualität zu gewährleisten
- Zwischen Raster- oder Seitenleisten-Layout wechseln, um ihren Vorlieben zu entsprechen
- Hintergrundunschärfe für Privatsphäre während des Meetings aktivieren oder deaktivieren
- Die Übersetzer-Sprache ändern, um die Kommunikation zwischen Teilnehmern zu erleichtern, die verschiedene Sprachen sprechen (siehe [AI Features](./ai-features#online-voice-translation))
...
- **Chat**: Teilnehmer können über das Seitenpanel Nachrichten an alle Anwesenden während des Anrufs senden, was Kommunikation und Zusammenarbeit fördert
- **Anheften / Nicht beobachten**: Benutzer können ihre Ansicht anpassen, indem sie bestimmte Teilnehmer anheften oder sie aus ihrem persönlichen Layout ausblenden, um ihr Meeting-Erlebnis individuell zu gestalten
...
| **Aufzeichnung**    | Klicken Sie, um die Aufzeichnung zu starten oder zu stoppen. Bei der Initiierung erhalten alle Teilnehmer eine sichtbare und hörbare Benachrichtigung. Diese Funktion ist ausschließlich für den Host und Moderator verfügbar (siehe [Benutzerrollen](./user-roles)) |

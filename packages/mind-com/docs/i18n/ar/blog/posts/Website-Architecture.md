...
يتم استخدام **خصائص CSS المنطقية** بدلاً من `left/right` التقليدية لإدارة اتجاه النص تلقائياً. توفر mixins في Sass توليد أنماط RTL/LTR تلقائياً، والأحرف الخاصة في Unicode (LRE، PDF) تتعامل بشكل صحيح مع الأقواس وعلامات الاقتباس في سياق RTL.

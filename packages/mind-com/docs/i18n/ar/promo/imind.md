...
<HeroSection
  title="مؤتمرات الفيديو والدردشة للأعمال"
  text="بنقرة واحدة. بدون تحميلات، بدون تثبيت. اجتماعات فيديو من الجيل القادم مع **ترجمة فورية** بأكثر من 30 لغة. مصمم **للفرق الدولية**.">
...
> [!warning] 🔴 خدمة imind.com المجانية لم تعد مدعومة.

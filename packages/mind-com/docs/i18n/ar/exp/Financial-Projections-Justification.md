...
| ---- | ------ | ----------------------------------------------------------------------------------------------------- |
| 1    | $178.9 | ARPU $36.8/شهر × 4.9 شهر متوسط فترة البقاء (المستخدمون الأوائل، معدل تسرب عالي في شريحة الخدمة المجانية).                      |
| 2    | $308.0 | ARPU $48.0/شهر × 6.4 شهر متوسط فترة البقاء (تحسن الاحتفاظ، عملاء B2B أكثر التصاقاً).                      |
| 3    | $470.0 | ARPU $58.8/شهر × 8.0 شهر متوسط فترة البقاء (هيمنة السوق المتوسط؛ ACV أعلى + تجديدات + ترقيات، معدل تسرب 10%). |

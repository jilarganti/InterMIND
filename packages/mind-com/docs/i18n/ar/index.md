...
<FeatureBlock :card="{
  ...
  details: 'بغض النظر عن اللغة، **يتم سماع صوتك وفهمه** كما لو كنتم تتحدثون نفس اللغة.',
    items: [
...
> [!note] ✅ وقتك أفضل أن يُقضى في إتقان مهنتك — وليس في حفظ قواعد اللغة.
...
[
  ...
  },
  {
    ...
    a: 'InterMind **خاص بالتصميم**. تتم معالجة وتخزين جميع البيانات داخل **منطقة الخصوصية** المختارة — _الاتحاد الأوروبي_، _الولايات المتحدة_، أو _آسيا_. نحن نمتثل لـ [**GDPR**](https://gdpr.eu) و [**CCPA**](https://oag.ca.gov/privacy/ccpa) وقانون حماية البيانات الشخصية الإماراتي، و**لا نستخدم محتواك أبداً** للتدريب أو الوصول من طرف ثالث. يتوفر **تحكم متقدم في منطقة الخصوصية** في خطة **Business**.'
  },
  {

...
<FeatureBlock :card="{
  ...
  details: 'مهما كانت اللغة، **يُسمع صوتك — ويُفهم** — كما لو كنتم تتحدثون نفس اللغة.',
    items: [
...
[
  ...
  },
  {
    ...
    a: 'بالتأكيد. تمنحك خطة *Free Basic* وصولاً كاملاً إلى الميزات الأساسية — بما في ذلك **الاجتماعات متعددة اللغات**، و**الترجمة النصية**، و**مساعد الذكاء الاصطناعي**. لا بطاقة ائتمان، **لا حد زمني**. يمكنك الترقية في أي وقت.'
  },
  {

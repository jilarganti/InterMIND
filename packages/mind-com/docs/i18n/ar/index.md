...
<HeroSection
  ...
  text="ترجمة الكلام المباشر في مكالمات الفيديو — **بلا** تأخير، **بلا** صفقات ضائعة، **بلا** حواجز لغوية.">
...
<FeatureBlock :card="{
  ...
  details: 'مهما كانت اللغة، **صوتك مسموع — ومفهوم** — كما لو كنتم تتشاركون نفس اللسان.',
    items: [
      '⚡︎ بطبيعية، في [الوقت الفعلي](./product/overview/how-it-works)، وبدون ترجمة نصية أو تأخير.',

...
إذا كنت قد استخدمت **Google Meet**، فأنت تعرف بالفعل كيف يعمل InterMind — فقط مع **الترجمة الفورية المباشرة** المدمجة. لا حاجة للإعداد. لا حاجة للتدريب. فقط تحدث — InterMind يتولى الباقي.

<FeatureCards :features="[
  {
    title: 'سجل مجاناً',
    details: '[سجل](#Pricing) أو سجل الدخول باستخدام لغتك المفضلة.',
    icon: {
      light: '/signUp.png',
      dark: '/signUp.png',
    }
  ...
  {
    title: 'ابدأ اجتماعاً',
    details: 'أنشئ اجتماعاً أو جدوله في تقويمك.',
    icon: {
      light: '/start.png',
      dark: '/start.png',
    }
  ...
  // {
  //   title: 'ادع ضيوفك',
  //   details: 'شارك الرابط - ضيفك ببساطة ينقر عليه وينضم بلغته.',
  //   icon: {
  //     light: '/invite.png',
  //     dark: '/invite.png',
  //   }
  ...
  {
    title: 'انضم للاجتماع',
    details: 'انقر على رابط الدعوة، اختر اسماً، وانضم للاجتماع.',
    icon: {
      light: '/join.png',
      dark: '/join.png',
    }
...
> 🔹 المستخدم يستعمل **الإسبانية** كـ **لغة توطين الموقع**  

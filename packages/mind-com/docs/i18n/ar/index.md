...
<AccordionGroup
    :items="[
      ...
      },
      {
        ...
        a: 'الدعم متاح عبر [مركز المساعدة](./resources/help). يحصل مستخدمو *الأعمال* على **دعم أولوية** مع جهة اتصال مخصصة.',
      },
      {

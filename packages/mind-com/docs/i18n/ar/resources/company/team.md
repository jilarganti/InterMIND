# في InterMind، البشر يقودون — الذكاء الاصطناعي يعزز
...
<TeamMembersGrid :members="[
  ...
  {
    name: 'Windicted',
    // desc: '**تحويل** المستخدمين إلى مؤمنين',
    country: 'البرتغال',
  ...
  {
    name: 'فريق **Mind.com**',
    desc: 'إزالة حواجز اللغة نهائياً',
    avatarLink: '/logo.svg',
    links: [
  ...
  // {
  //   name: 'Sfdev',
  //   // desc: '**جعل** المستخدمين يبقون — ويبتسمون',
  //   country: 'البرتغال',
  ...
  // {
  //   name: 'DMA',
  //   // desc: '**تحويل** الاجتماعات إلى معنى',
  //   // country: 'عالمياً',

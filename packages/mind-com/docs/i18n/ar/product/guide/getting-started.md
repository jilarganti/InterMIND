---
title: البدء
description: تعلم كيفية استخدام منصة InterMIND للمؤتمرات المرئية المدعومة بالذكاء الاصطناعي. دليل شامل للتسجيل وإنشاء الاجتماعات وميزات الذكاء الاصطناعي واستكشاف الأخطاء وإصلاحها.
---

# البدء

InterMIND هي منصة متقدمة للمؤتمرات المرئية مدعومة بالذكاء الاصطناعي مصممة لتسهيل التواصل السلس عبر مختلف اللغات والأجهزة والفرق. يهدف هذا الدليل إلى تزويدك بفهم شامل لكيفية الاستفادة بفعالية من جميع ميزات InterMIND — من الانضمام إلى اجتماعك الأول إلى تكوين أدوات الذكاء الاصطناعي ومعالجة المشاكل التقنية.

سواء كنت مستخدماً مبتدئاً تبحث عن إرشادات مفصلة أو مشاركاً ذا خبرة يشرف على اجتماعات معقدة، فإن هذا الدليل يجمع جميع المعلومات الضرورية في مكان واحد يسهل الوصول إليه.

في هذا الدليل، ستكتشف:

- تعليمات حول كيفية [التسجيل وتسجيل الدخول وتخصيص ملفك الشخصي](./account-management)
- إرشادات [إنشاء وجدولة الاجتماعات](./creating-meetings)
- معلومات حول [أدوار المستخدمين](./user-roles) والصلاحيات و[قدرات الترجمة الفورية](./ai-features#online-voice-translation)
- نظرة عامة على [الميزات المدعومة بالذكاء الاصطناعي](./ai-features) مثل المساعد الذكي ومترجم الصوت
- [نصائح استكشاف الأخطاء وإصلاحها](./troubleshooting) وإجابات على [الأسئلة الشائعة](./faq)
...
2. انقر على تسجيل الدخول واختر Google / Microsoft / البريد الإلكتروني (تعرف على المزيد في [إدارة الحساب](./account-management))
3. عند المطالبة، اسمح بالوصول إلى الميكروفون والكاميرا
4. انقر على اجتماع جديد واختر بدء اجتماع فوري (راجع [إنشاء وجدولة الاجتماعات](./creating-meetings))
5. شارك رابط الاجتماع مع المشاركين
6. افتح الإعدادات لاختيار اللغة والأجهزة المفضلة لديك
7. استخدم [المساعد الذكي](./ai-features#ai-assistant) لتدوين الملاحظات وإنشاء الملخصات أثناء المكالمة
8. الوصول إلى الاجتماعات السابقة عبر تبويب السجل للتسجيلات والنصوص المكتوبة

> [!TIP]
> للحصول على أفضل أداء، يُنصح باستخدام متصفح Chrome أو Edge. إذا واجهت أي مشاكل، راجع دليل [استكشاف الأخطاء وإصلاحها](./troubleshooting) أو قم بزيارة [المساعدة والدعم](./help-support).
...
- يقع مبدل اللغة في رأس الصفحة، بجانب زر تسجيل الدخول للمستخدمين غير المخولين، أو بالقرب من أيقونة الصورة الرمزية للمستخدمين المخولين
- مبدل اللغة الموجود في تذييل الصفحة بجانب نص '© Mind, 2025.'
- علاوة على ذلك، يمكن للمستخدمين تغيير اللغة عبر خيار 'الملف الشخصي > الإعدادات > لغتك'، أو أثناء الاجتماع بالانتقال إلى 'إظهار القائمة > الإعدادات > الإعدادات > لغتك'

فيما يلي قائمة باللغات المتاحة حالياً في InterMIND:
...
- حافظ على حد أدنى لسرعة الرفع/التنزيل 2 ميجابت في الثانية

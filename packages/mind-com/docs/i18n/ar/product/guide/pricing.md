...
- انتقل إلى الملف الشخصي > تبويب الملف الشخصي (راجع [إدارة الحساب](./account-management#user-profile))
...
| **المحترف**   | 25 دولار/شهر (أو 20 دولار/شهر عند الدفع سنوياً) | اجتماعات غير محدودة، 150 مشارك، 2 تيرابايت تخزين، جميع ميزات الذكاء الاصطناعي |
| **الأعمال**   | مخصص (اتصل بالمبيعات)                      | 500 مشارك، 5 تيرابايت تخزين، زميل ذكي (نسخة تجريبية)، ميزات المؤسسات      |
...
- يمكن للمستخدمين الوصول إلى سجل المدفوعات والفواتير في قسم الفوترة
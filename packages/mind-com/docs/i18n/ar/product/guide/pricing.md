...
توفر صفحة التسعير مقارنة واضحة لجميع الخطط المتاحة—الأساسية والاحترافية وخطة الأعمال—مما يساعد المستخدمين على اختيار الخيار الأفضل لاحتياجات التواصل الخاصة بهم. تتضمن تفاصيل حول التسعير وحدود الاجتماعات وسعة المشاركين والتخزين والوصول إلى الميزات المتميزة مثل Voice Assistant وAI Assistant وخدمات الترجمة الفورية.
...
- اذهب إلى: [https://intermind.com/pricing](https://intermind.com/pricing)
...
| ------------ | ---------------------------------------- | ------------------------------------------------------------------------- |
| **الأساسية**    | مجاناً                                     | 25 اجتماع، 100 مشارك، 30 جيجابايت تخزين، ترجمة محدودة      |
| **المحترفة**      | 25 دولار/شهرياً (أو 20 دولار/شهرياً عند الدفع سنوياً) | اجتماعات غير محدودة، 150 مشارك، 2 تيرابايت تخزين، جميع ميزات الذكاء الاصطناعي       |
| **الأعمال** | مخصص (اتصل بالمبيعات)                   | 500 مشارك، 5 تيرابايت تخزين، زميل الذكاء الاصطناعي (نسخة تجريبية)، ميزات المؤسسات |

### نقاط مميزة أخرى

- التبديل بين **الشهري** و**السنوي** يُفعل التسعير المخفض لخطة المحترفة
...
- عند النقر على **اشتري الآن** سيتم توجيه المستخدمين إلى صفحة دفع Stripe آمنة في علامة تبويب جديدة

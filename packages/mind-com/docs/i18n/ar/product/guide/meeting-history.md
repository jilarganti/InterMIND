...
description: اطلع على أرشيف اجتماعات InterMIND مع التسجيلات والنصوص المكتوبة والملخصات المُولدة بالذكاء الاصطناعي وروابط الاجتماعات القابلة لإعادة الاستخدام في مكان واحد.
---

# سجل الاجتماعات

تعمل صفحة سجل الاجتماعات كأرشيف شخصي لجميع الاجتماعات التي استضفتها أو حضرتها أثناء تسجيل الدخول. توفر وصولاً سريعاً إلى التسجيلات والنصوص المكتوبة والملخصات المُولدة بواسطة المساعد الذكي وروابط الاجتماعات القابلة لإعادة الاستخدام - كل ذلك مُجمع في موقع واحد مريح.
...
- أو بدلاً من ذلك، انقر على أيقونة الصورة الرمزية الخاصة بك في الزاوية العلوية اليمنى، ثم اختر **السجل** من القائمة المنسدلة
- يمكنك أيضاً التنقل مباشرة إلى الرابط التالي: [https://intermind.com/history](https://intermind.com/history)

## قائمة الاجتماعات

تتضمن كل مدخلة في سجل اجتماعاتك:
...
عند النقر على هذا الإجراء، سيتلقى المستخدمون إشعاراً يطالبهم بتأكيد الحذف من خلال النقر على زر **نعم، احذف** أو إلغاء العملية من خلال النقر على زر **إلغاء**. الاجتماعات المحذوفة لن تعود مرئية لأي من المشاركين. فقط المضيفون أو المشرفون يملكون صلاحية حذف الاجتماع (انظر [أدوار المستخدمين](./user-roles)).
...
يمكّن هذا المستخدمين من الحصول على ملخص الاجتماع من [المساعد الذكي](./ai-features#ai-assistant) في شكل محادثة.
...
> [!TIP]
> استفد من صفحة سجل الاجتماعات لإعادة تشغيل المناقشات الرئيسية، واسترجاع الملاحظات المهمة، ومتابعة عناصر العمل باستخدام الملخصات والنصوص المكتوبة—مما يجعلها أداة أساسية لتوثيق الفريق والمراجعات أو سير عمل الامتثال.
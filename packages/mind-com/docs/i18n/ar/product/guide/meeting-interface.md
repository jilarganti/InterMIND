---
title: نظرة عامة على واجهة الاجتماع
description: استكشف واجهة اجتماعات InterMIND البديهية. تعرف على تخطيط الفيديو وأدوات التحكم وتفاعلات المشاركين وخيارات التخصيص.
---
...
عند حضور اجتماع—سواء كمضيف أو مشرف أو مشارك أو ضيف—يختلف تخطيط الشاشة بناءً على دورك (راجع قسم [أدوار المستخدمين](./user-roles)). يشمل التخطيط:

- **شريط الحالة العلوي**: يعرض هذا الشريط رابط الاجتماع وحالة الأمان ومؤشر التسجيل والترجمة، مما يوفر المعلومات الأساسية فوراً
...
- **اللوحة الجانبية (اختيارية)**: تتضمن هذه اللوحة الدردشة وقائمة المشاركين و[المساعد الذكي](./ai-features#ai-assistant)، مما يعزز تفاعل المستخدم

## خيارات التخصيص السريع

في الإعدادات، يمكن للمستخدمين:

- اختيار أجهزة الميكروفون والسماعة والكاميرا الخاصة بهم لضمان جودة صوتية ومرئية مثلى
- التبديل بين تخطيط الشبكة أو الشريط الجانبي لتناسب تفضيلاتهم
- تفعيل أو إلغاء تفعيل ضبابية الخلفية للخصوصية أثناء الاجتماع
- تغيير لغة المترجم لتسهيل التواصل بين المشاركين الذين يتحدثون بلغات مختلفة (راجع [AI Features](./ai-features#online-voice-translation))

## ميزات تفاعل المشاركين

يمكن للمشاركين التفاعل بنشاط في الاجتماع باستخدام عدة أدوات متاحة ضمن الواجهة:

- **رفع اليد**: يمكن للمشاركين النقر على هذا الخيار للإشارة إلى رغبتهم في التحدث. ستظهر أيقونة يد بجانب اسمهم في قائمة المشاركين، مما يشير إلى طلبهم
- **خفض اليد**: يمكن للمضيفين والمشرفين خفض يد المشارك المرفوعة يدوياً، للحفاظ على النظام أثناء المناقشات
- **المحادثة**: يمكن للمشاركين إرسال رسائل إلى جميع الحاضرين أثناء المكالمة باستخدام اللوحة الجانبية، مما يعزز التواصل والتعاون
- **تثبيت / عدم المشاهدة**: يمكن للمستخدمين تخصيص عرضهم من خلال تثبيت مشاركين محددين أو إخفاؤهم من تخطيطهم الشخصي، مما يتيح تخصيص تجربة الاجتماع الخاصة بهم
...
| **الكاميرا** | انقر لتشغيل أو إيقاف الكاميرا، مما يمكّن أو يعطل تغذية الفيديو الخاصة بك للمشاركين |
...
| **التسجيل** | انقر لبدء أو إيقاف التسجيل. عند البدء، سيتلقى جميع المشاركين إشعاراً مرئياً ومسموعاً. هذه الميزة متاحة حصرياً للمضيف والمشرف (راجع [أدوار المستخدمين](./user-roles)) |
...
| **المشاركون** | يفتح قائمة المشاركين، مما يعرض أدوارهم مثل المضيف والمشرف وغيرها |
| **المحادثة** | انقر لإظهار أو إخفاء ميزة المحادثة، مما يسهل التفاعل مع المشاركين الآخرين أثناء الاجتماع |
| **رابط الاجتماع** | رابط الاجتماع متاح في شريط عنوان المتصفح أو يمكن نسخه من الزاوية اليسرى السفلى عن طريق تحديد رابط 'مشاركة'. لمستخدمي الهاتف المحمول، يُعرض هذا الرابط تحت عناصر خيار 'إظهار القائمة' |
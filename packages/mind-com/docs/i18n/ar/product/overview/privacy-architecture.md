---
title: خصوصية البيانات للاجتماعات المدعومة بالذكاء الاصطناعي
description: هيكل الخصوصية الشفاف من InterMIND مع السرية القائمة على المنطقة والامتثال للائحة العامة لحماية البيانات وخيار المستخدم لمواقع معالجة البيانات.
---

# خصوصية البيانات للاجتماعات المدعومة بالذكاء الاصطناعي
...
لتقديم تجربة سلسة، تدمج InterMind خدمات طرف ثالث للفيديو والصوت والتخزين السحابي والترجمة الفورية والتحليلات. مقدمو الخدمات من الطرف الثالث هؤلاء يساعدوننا في ضمان الأداء وقابلية التوسع — لكنهم يقدمون أيضاً طبقة لا يمكننا التحكم بها مباشرة.

تعرف على المزيد حول [كيف تعمل منصتنا](./how-it-works) و[ميزات منصة اجتماعات الفيديو](./video-meeting-platform) الخاصة بنا.
...
- نحن **نتحكم** في البرمجيات من جانب العميل، وقواعد التوجيه، ومنطق الامتثال — بما في ذلك المنطقة التي تتدفق بياناتك من خلالها، والنموذج المستخدم، والشروط المطبقة.

### 2. **الشفافية المعمارية**

- يمكنك رؤية المنطقة النشطة لجلستك بوضوح، والقوانين المطبقة (مثل GDPR في أوروبا، CCPA في الولايات المتحدة، PDPL في دولة الإمارات العربية المتحدة).
...
- **إدراج مناطق معينة في القائمة السوداء** بالكامل
...
الوظائف من جانب العميل مثل التقاط الصوت وعرض واجهة المستخدم يتم التعامل معها محلياً كلما أمكن ذلك.

### 2. **تقليل البيانات**

يتم نقل الحد الأدنى من البيانات الضرورية للمهمة الحالية فقط.

### 3. **التشفير من النهاية إلى النهاية**

جميع بيانات الصوت/الفيديو يتم نقلها عبر قنوات مشفرة. طلبات الترجمة الفورية يتم توجيهها عبر خوادم وكيلة آمنة، تجنباً للتعرض العام.
...
> لا يمكن لـ InterMind ضمان كيفية معالجة مقدمي نماذج اللغة الكبيرة أو البنية التحتية من الأطراف الثالثة للبيانات بمجرد خروجها من سيطرتنا.
...
- أن InterMind **لا** يخزن أو يستغل محتواك أبداً — حتى مؤقتاً — بدون موافقتك.

## أنماط الثقة ومستويات الخصوصية

يمكنك تخصيص جلستك لتتناسب مع احتياجاتك في السرية:

| نمط الثقة        | التفسير       | النقل عبر المناطق      | التخزين           | الأنسب لـ                           |
| ---------------- | -------------- | --------------------- | ------------------ | ----------------------------------- |
| 🔒 محلي فقط      | ❌             | ❌                    | ❌                 | القانونية، الحكومية، المراجعات الداخلية |
| 🔐 مقيد بالمنطقة | ✅             | ✅ (داخل المنطقة فقط) | ❌ أو للجلسة فقط   | الرعاية الصحية، المالية، الموارد البشرية |
...
> **أسئلة حول الخصوصية؟** [اتصل بنا](../../resources/company/contacts) أو اقرأ عن [قيم شركتنا](../../resources/company/about).
...
[私たちが構築しているもの](../../product/overview/what-is-intermind)と[その仕組み](../../product/overview/how-it-works)について詳しく学んでください。
...
[our team](./team)に会い、[our company values](./about)について学びましょう。

## 私たちと一緒に働きませんか

すでに意義のあるものを構築し、世界を変えるテクノロジーを構築する準備ができているなら、ぜひご連絡ください。
...
_InterMIND — 世界を真にグローバルにするテクノロジー。_
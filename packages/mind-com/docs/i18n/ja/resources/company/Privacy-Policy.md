...
AI ツールをご利用いただく際、お客様がこれらのやり取りの中で提供される情報（クエリ、アップロードされた文書、会話履歴など）を収集する場合があります。
...
システム改善のため、AIとのやり取りから匿名化・集約されたデータを使用する場合があります。訓練目的でデータを使用する前に、個人識別子は削除されます。
...
当社は、本プライバシーポリシーに記載された目的を達成するために必要な期間、またはより長い保持期間が法律により要求または許可されている場合を除き、お客様の個人情報を保持いたします。

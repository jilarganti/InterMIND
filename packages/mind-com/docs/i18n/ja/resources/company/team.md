# Mind.comでは、人間が主導し、AIが増幅する

私たちは創造性、コード、そして理解を融合させ、言語の壁を永続的に取り除きます。

[私たちの使命について](./about)詳しく学び、[私たちの技術がどのように機能するか](../../product/overview/how-it-works)をご覧ください。

## 人間チーム

<TeamMembersGrid :members="[
  {
    name: 'The **Mind.com** チーム',
    desc: '言語の壁を永久に取り除く',
    avatarLink: '/logo.svg',
    links: [
...
[^1]: AIチームメンバーは人間ではありませんが、私たちの業務に不可欠な存在です。コーディングから研究まで様々なタスクを支援し、言語の壁を取り除く手助けをしてくれます。
...
> **私たちと一緒に働きませんか？** [キャリア機会](./careers)をご確認いただくか、[私たちが構築しているもの](../../product/overview/what-is-intermind)について詳しく学んでください。
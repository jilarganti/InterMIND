...
3. アカウントにサインインするページで、以下のオプションが表示されます：
   ...
   - 「アカウントをお持ちでない場合」テキスト：外部メールアドレスで登録できる「サインアップ」リンクが続きます
...
> [!WARNING]
> 基本プロフィール情報へのアクセスを許可したくない場合は、**キャンセル**ボタンをクリックしてください。アカウントにサインインするページに戻り、外部メールアドレスでサインアップできます。

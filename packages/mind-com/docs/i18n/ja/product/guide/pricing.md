...
料金プランページでは、利用可能なすべてのプラン（ベーシック、プロ、ビジネス）の明確な比較を提供し、ユーザーがコミュニケーションニーズに最適なオプションを選択できるよう支援します。料金、会議制限、参加者数、ストレージ、Voice Assistant、AI Assistant、通訳サービスなどのプレミアム機能へのアクセスに関する詳細が含まれています。
...
- 認証済みユーザーは、履歴リンクの隣にある**料金**リンクをクリック
...
| プラン         | 価格                                    | 主な機能                                                              |
| ------------ | ---------------------------------------- | ------------------------------------------------------------------------- |
| **ベーシック**    | 無料                                     | 25会議、100参加者、30 GBストレージ、限定通訳機能      |
| **プロ**      | $25/月（年間請求の場合$20/月） | 無制限会議、150参加者、2 TBストレージ、全AI機能       |
| **ビジネス** | カスタム（営業にお問い合わせ）                   | 500参加者、5 TBストレージ、AIコリーグ（アルファ版）、エンタープライズ機能 |
...
- 請求サイクルと利用枠は選択されたプランに応じてリセットされます
- 会議数、参加者数、ユーザーあたりのストレージの利用枠は、アクティブなプランに基づいて適用されます
- 利用枠を超過すると、**プランをアップグレード**ボタンと共に明確な通知が表示されます

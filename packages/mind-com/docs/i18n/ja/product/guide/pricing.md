---
title: 料金プラン
description: InterMINDプランの比較 - ベーシック、プロ、ビジネス。会議制限、参加者数、AI機能、ストレージオプションで最適なプランを見つけましょう。
---
...
- プロフィール > プロフィールタブに移動（[アカウント管理](./account-management#user-profile)を参照）
...
| **プロ**      | $25/月（年間請求の場合$20/月） | 無制限のミーティング、150名の参加者、2 TBストレージ、全てのAI機能       |
...
> [!TIP]
> プランのアップグレードは即座に有効になり、拡張された機能制限が適用されます。
...
- 完了には以下の項目の入力が必要です：
  ...
  - カード名義人
  - 国/地域
- Stripeがセキュアな決済処理を保証します
- ユーザーはLinkを使用して決済情報を保存することも可能です
...
- 利用枠を超過した場合、明確な通知と**プランをアップグレード**ボタンが表示されます

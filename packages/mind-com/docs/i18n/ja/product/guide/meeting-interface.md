...
会議に参加する際—ホスト、モデレーター、参加者、またはゲストとして—画面レイアウトはあなたの役割によって異なります（ユーザー役割セクションを参照）。レイアウトには以下が含まれます：
...
- **サイドパネル（オプション）**: このパネルにはチャット、参加者リスト、AI Assistantが含まれ、ユーザーインタラクションを向上させます
...
| **会議リンク**  | 会議リンクは、ブラウザのアドレスバーでアクセスできるか、左下角の「共有」リンクを選択してコピーできます。モバイルユーザーの場合、このリンクは「メニューを表示」オプション項目の下に表示されます |
---
title: AI機能
description: InterMINDのAI搭載機能をご紹介します。音声アシスタント（Jarvis）、リアルタイム音声翻訳、会議メモと要約のためのAIアシスタントなど。
---
...
- 個人翻訳設定（他の参加者に影響しません）
- 設定パネルを通じていつでも翻訳言語を変更可能（[会議インターフェース](./meeting-interface)を参照）
- すべての参加者タイプで利用可能（ホスト、モデレーター、参加者、ゲスト - [ユーザーロール](./user-roles)の詳細を確認）
...
AIアシスタントは、会議内でプライベートチャットインターフェースとしてアクセス可能です。ユーザーはAIアシスタントパネルを開いて、テキスト形式でアシスタントとやり取りすることができ、以下に関する問い合わせが可能です：
...
> [!WARNING]
> AIアシスタントは、ホスト、モデレーター、または参加者を含む、サインインしたユーザーのみが利用できます。チャットで公開的にやり取りすることはなく、ゲストユーザーはアクセスできません。詳細については[ユーザーロール](./user-roles)をご覧ください。

---
title: "よくある質問（FAQ）"
description: "InterMINDに関するよくある質問への回答をご覧ください。アカウント、会議、AIアシスタント、翻訳機能、デバイス互換性について学びましょう。"
---

# よくある質問（FAQ）

FAQセクションでは、InterMINDに関する重要な情報を提供しており、アカウントとアクセス、会議の作成と録画、AIアシスタントの機能、翻訳機能、チャット参加、デバイス設定などのトピックを扱っています。ゲストアクセス、会議のスケジュール設定、AIアシスタントの使用、言語翻訳、チャット機能、デバイス互換性に関するよくある質問にお答えします。

## アクセス

**ミーティングに参加するためにサインアップする必要がありますか？**
いいえ、ゲストはサインインせずにミーティングリンクを使用して参加できます。ただし、アクセスは制限されます（例：AI アシスタントやミーティング履歴は利用できません）。

**Google または Microsoft アカウントを使用してサインアップできますか？**
はい、Google または Microsoft アカウントを使用して、ワンクリックで簡単に登録またはログインできます。
...
はい、サインインしているユーザーは履歴ページから過去のミーティングにアクセスでき、AI Assistantタブを通じてそれらのミーティングの録画、トランスクリプト、要約を確認できます。

**履歴からミーティングを削除できますか？**
ホストとモデレーターのみがミーティング記録を削除する権限を持っており、削除すると全参加者の履歴から効果的に削除されます。

**過去のミーティングを共有するにはどうすればよいですか？**
過去のミーティングを共有するには、履歴ページにある**共有**ボタンを使用してミーティングリンクをクリップボードにコピーしてください。
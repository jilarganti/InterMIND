---
title: AIリアルタイム翻訳の仕組み
description: InterMINDの音声認識、ニューラル翻訳、音声合成を活用した瞬時双方向翻訳によるシームレスなコミュニケーションの仕組みを学びましょう。
---
...
InterMindは**瞬時双方向翻訳**機能を備えたマルチユーザービデオ会議プラットフォームです。各参加者は**母国語**で話し、他の参加者の声を聞くことができ、言語の壁のない自然なコミュニケーションを実現します。

[InterMINDの特徴](./what-is-intermind)と[プラットフォームの全機能](./video-meeting-platform)について詳しくご覧ください。
...
> **詳しく知りたいですか？** [翻訳と通訳の違い](./translation-vs-interpretation-whats-the-difference)について読むか、[データプライバシー](./privacy-architecture)への私たちのアプローチをご覧ください。
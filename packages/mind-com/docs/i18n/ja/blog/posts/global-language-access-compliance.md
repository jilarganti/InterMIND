...
<div class="stats-grid">
  <div class="stat-card">
    ...
    <div class="stat-label">法律を持つ国</div>
  </div>
  <div class="stat-card">
...
- ウェブサイトとモバイルアプリは**WCAG 2.1レベルAA**に準拠する必要がある
...
- **大統領令14224（2025年）** – EO 13166を撤回したが、基本法は有効

**注意：** 大統領令14224で英語を「公用語」と指定したにもかかわらず、第VI編およびその他の言語アクセスを要求する法律は完全に有効です。
...
- 連邦規制組織は**2024年**までにウェブサイト・アプリをアクセシブルにすることが義務付けられている
...
- EU顧客にサービスを提供する場合、**準拠が必要**（GDPRと同様）
...
**注意：** 英国はEUを離脱したが、EU顧客にサービスを提供する企業はEAAに準拠する必要がある。
...
- **Bruce Maguire v SOCOG（2000年）：** 画期的な事例、アクセシブルでないオリンピックウェブサイトに対し20,000ドルの損害賠償
- **Gisele Mesnage v Coles（2014年）：** 連邦巡回裁判所での初のウェブアクセシビリティ事例
...
- 虚偽のアクセシビリティ表示に対し最大**20万円**（約1,700米ドル）の罰金
- 非準拠による法的措置
...
### Q: コンプライアンスを遵守しない場合はどうなりますか？

結果には以下が含まれます：

- 💰 金銭的制裁（1,700ドルから100,000ドル以上の罰金または収益の一定割合）
- ⚖️ 法的措置と訴訟
- 🚫 政府契約の失失
- 📉 評判の損害
- 🔒 運営上の制限
...
1. **デジタル資産をWCAG 2.1 AAに対して監査する**
2. **事業拠点と顧客基盤に適用される法律を特定する**
3. **明確な優先順位とタイムラインを持つ改善ロードマップを策定する**
4. **アクセシビリティソリューションを実装する**（AI翻訳、字幕、スクリーンリーダーサポート）
5. **自動化ツールと実際のユーザーで徹底的にテストする**
6. **アクセシビリティプログラムを文書化し維持する**

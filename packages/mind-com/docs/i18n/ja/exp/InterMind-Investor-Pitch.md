# InterMind投資家向けピッチ：グローバルビジネスの言語障壁を打破する <Badge type="success" text="updated" />
...
- 有料検索：高意図のローカライズされたクエリ（「ビジネス会議で英語を話す方法」）
...
私たちは、メキシコ、ブラジル、トルコ、タイ、インドネシアでの市場参入パイロットを開始しており、B2B貿易量が多く、英語でのビジネスコミュニケーションの需要が高い地域をターゲットにしています。

...
この文書では、InterMindの最初の3年間におけるユーザー成長、収益（ARR）、およびユニットエコノミクスの財務モデルの前提について説明します。
...
| 2    | $8,985,600  | 15,600有料アカウント × 2.0平均ライセンス × $24.00/月 → 改善されたフリーミアム転換 + アクティブなB2B獲得。                  |
...
**Y3：** 部門全体での採用 — 中堅企業が複数のチームと部門にわたって規模を拡大
...
| 3    | 80%    | 自社音声/LLMモデル、自動スケーリングインフラ、ユーザーあたり定額インフラ。B2B機能は限界費用が低く高価格設定。 |
...
| **ペイバック期間**          | 8.5ヶ月 | 5.8ヶ月 | 4.2ヶ月 | <12ヶ月       |
| **総収益維持率** | 85%    | 88%    | 90%    | >85%         |
...
> **結論:** これらの予測は、成長への野心と規律あるSaaSエコノミクスのバランスを取り、持続可能なLTV/CAC比率（3年目までに5倍以上）と80%以上の粗利益率を目標とし、現実的な顧客ベースセグメンテーションを採用しています。
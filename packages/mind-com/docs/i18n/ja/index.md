---
layout: home
title: "ビデオ会議のためのリアルタイム音声翻訳"
description: "19以上の言語での同時通訳機能を備えたプロフェッショナルビデオ会議。トーン、意図、文脈を捉えるAI翻訳。グローバルに会議し、自然にコミュニケーション。"
isHome: true
---
...
## Google Meet + リアルタイム翻訳のように動作 {#HowItWorks}

使い慣れたインターフェース。ユニバーサルコミュニケーション。Google Meetと同じ使いやすさ — 言語の壁を瞬時に取り除くリアルタイム翻訳付き。
...
<AuthButton text="今すぐ始める" button-class="brand" event-name="get_started_attempt"/>
...
<AccordionGroup
    :items="[
      ...
      },
      {
        ...
        a: 'すべてのプランで、ミーティングは最大**24時間**まで実行できます。',
      },
      {
      ...
      },
      {
        ...
        a: 'InterMindは**プライバシーバイデザイン**です。すべてのデータは選択した**プライバシーゾーン**（_EU_、_US_、または_アジア_）内で処理・保存されます。[**GDPR**](https://gdpr.eu)、[**CCPA**](https://oag.ca.gov/privacy/ccpa)、UAE PDPLに準拠し、**お客様のコンテンツを**トレーニングやサードパーティアクセスに**決して使用しません**。高度な[プライバシーゾーン制御](./product/overview/privacy-architecture)は**ビジネス**プランで利用可能です。',
      },
      {
        q: 'プランを購入する前にInterMindを試すことはできますか？',
        a: 'もちろんです。*無料ベーシック*プランでは、**25回の無料ミーティング**を含む**同時通訳**と**ミーティング検索**を含むコア機能にフルアクセスできます。クレジットカードは不要です。いつでもアップグレード可能です。',
      },
      {
...
<HomeFooter
    :columns="[
      ...
      },
      {
        ...
        links: [
          { text: 'ブログ', link: './blog/' },
          { text: 'グローバル言語アクセスコンプライアンス', link: './blog/posts/global-language-access-compliance' },

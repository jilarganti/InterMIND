# Resumo executivo InterMind <Badge type="warning" text="draft" />
...
- Mercados emergentes (LATAM, SEA, MENA) têm baixa proficiência em inglês, mas alto volume de negócios

...
- **Capital mínimo**: AED 2M em licença comercial ou industrial válida.
...
>
> - Residentes dos EAU: média de 3 meses para processamento
...
> [!NOTE] 💚 Os regulamentos e requisitos de visto estão sujeitos a alterações. Para obter informações atualizadas, consulte fontes oficiais do governo dos EAU ou um especialista jurídico.
...
**1. Quanto tempo leva para obter um Golden Visa dos EAU?**
...
> [!NOTE] 💚 Nosso modelo de taxa baseado em sucesso significa que você não paga nada até que seu Golden Visa seja aprovado. 98% de nossas aplicações são bem-sucedidas, e fornecemos suporte completo durante todo o processo.
...
<ContactFormModal formName="Golden Visa" buttonText="Obtenha uma consultoria gratuita"
  :services="[

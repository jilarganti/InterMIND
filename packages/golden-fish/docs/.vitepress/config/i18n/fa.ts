...
export const fa = defineConfig({
  description: "خدمات تخصصی تشکیل شرکت در امارات متحده عربی و پشتیبانی. راه‌اندازی شرکت، بانکداری، مالیات، حقوقی و راه‌حل‌های ویزا. رویاهای تجاری شما را به واقعیت تبدیل می‌کنیم!",
  head: [
    ["meta", { property: "og:title", content: "خدمات تخصصی تشکیل شرکت در امارات متحده عربی و پشتیبانی. راه‌اندازی شرکت، بانکداری، مالیات، حقوقی و راه‌حل‌های ویزا." }],
  ],

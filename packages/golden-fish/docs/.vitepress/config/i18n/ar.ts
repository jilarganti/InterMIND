...
export const ar = defineConfig({
  description: "خدمات خبيرة لتأسيس الشركات والدعم في دولة الإمارات العربية المتحدة. تأسيس الشركات، الخدمات المصرفية، الضرائب، الحلول القانونية وحلول التأشيرات. نحول أحلامك التجارية إلى حقيقة!",
  head: [
    ["meta", { property: "og:title", content: "خدمات خبيرة لتأسيس الشركات والدعم في دولة الإمارات العربية المتحدة. تأسيس الشركات، الخدمات المصرفية، الضرائب، الحلول القانونية وحلول التأشيرات." }],
  ],

...
export const hi = defineConfig({
  description: "UAE में विशेषज्ञ कंपनी गठन और सहायता सेवाएं। कंपनी स्थापना, बैंकिंग, कर, कानूनी और वीजा समाधान। आपके व्यवसायिक सपनों को साकार करना!",
  head: [["meta", { property: "og:title", content: "UAE में विशेषज्ञ कंपनी गठन और सहायता सेवाएं। कंपनी स्थापना, बैंकिंग, कर, कानूनी और वीजा समाधान।" }]],
  ...
  themeConfig: {
    ...
    footer: {
      message: `© Golden Fish, 2025. | <a href="#" onClick="UC_UI.showSecondLayer();">गोपनीयता सेटिंग्स</a> | <a href="${BASE_PATH}/resources/TERMS-CONDITIONS">नियम और शर्तें</a> | <a href="${BASE_PATH}/resources/Privacy-Policy">गोपनीयता नीति</a> | <a href="${BASE_PATH}/resources/Legal-Regulations-for-AI-Services">AI सेवाओं के लिए कानूनी नियम</a>`,
    },
...
function sidebarServices(): DefaultTheme.SidebarItem[] {
  return [
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        { text: "कंपनी पंजीकरण चरण", link: "company-registration/insights/incorporation-steps" },
...
function sidebarInsights(): DefaultTheme.SidebarItem[] {
  return [
    ...
    { text: "नियम और शर्तें", link: "TERMS-CONDITIONS" },
    { text: "गोपनीयता नीति", link: "Privacy-Policy" },
    { text: "AI सेवाओं के लिए कानूनी नियम", link: "Legal-Regulations-for-AI-Services" },
  ]
}

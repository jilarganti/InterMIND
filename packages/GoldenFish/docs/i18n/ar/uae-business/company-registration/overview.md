...
👎 **تعقيد إنشاء الأعمال**: تنوع خيارات تأسيس الأعمال واللوائح المعقدة قد يكون مربكاً ومرهقاً للقادمين الجدد.
...
**أفضل الاستخدامات**: مناسبة للعملاء الراغبين في تأسيس شركة قابضة، أو ممارسة الأعمال التجارية الدولية، أو امتلاك أصول عقارية في الإمارات.
...
- **الرخص التجارية**: هذه مخصصة للشركات التي تمارس الأنشطة التجارية، وتسمح لها بإجراء عمليات التداول وإصدار الفواتير للعملاء. إذا كان عملك يتضمن شراء أو بيع البضائع، فهذه الرخصة هي الأنسب على الأرجح.
...
<ContactFormModal 
  ...
  categoryPlaceholderText="اختر مستوى الدعم المطلوب"
  messageLabel="ساعدنا في التحضير لاستشارتك (موصى به)"
  messagePlaceholderText="أخبرنا عن نوع نشاطك التجاري، والأنشطة المخطط لها في الإمارات، والجدول الزمني، وأي أسئلة محددة حول تأسيس الشركة أو التأشيرات"
  :services="[
  'أساسي — استشارة المستندات الأساسية وتسجيل الشركة فقط',
  'قياسي — مستندات كاملة وتوجيه خلال المراحل الرئيسية للتأسيس',
  'شامل — خدمة تأسيس شركة كاملة مع حد أدنى من المشاركة من جانبك',
  'مخصص — بحاجة إلى مناقشة هيكل معقد أو إعداد أعمال متعدد الولايات القضائية',
  ]"
/>
...
export const hi = defineConfig({
  description: "विशेषज्ञ UAE कंपनी गठन और सहायता सेवाएं। कंपनी स्थापना, बैंकिंग, कर, कानूनी और वीजा समाधान। आपके व्यापार सपनों को साकार करना!",
  head: [
    ["meta", { property: "og:title", content: "विशेषज्ञ UAE कंपनी गठन और सहायता सेवाएं। कंपनी स्थापना, बैंकिंग, कर, कानूनी और वीजा समाधान।" }],
  ],
  ...
  themeConfig: {
    ...
    footer: {
      message: `©Golden Fish, 2025. | <a href="#" onClick="UC_UI.showSecondLayer();">गोपनीयता सेटिंग्स</a> | <a href="${BASE_PATH}/resources/Privacy-Policy">गोपनीयता नीति</a> | <a href="${BASE_PATH}/resources/Legal-Regulations-for-AI-Services">AI सेवाओं के लिए कानूनी विनियमन</a>`,
    },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "UAE फ्री जोन्स", link: "company-registration/free-zones" },
        { text: "UAE मेनलैंड", link: "company-registration/mainland" },
      ],
    },
    {
      text: "UAE व्यापार अनुपालन गारंटीड",
      collapsed: false,
      items: [
        { text: "गारंटीड कॉर्पोरेट बैंक खाता अनुमोदन", link: "corporate-banking-services/guaranteed-account-approvals" },
    ...
    {
      text: "कानूनी, लेखांकन और कर",
      collapsed: false,
      items: [
        { text: "लेखांकन और कर विचार", link: "company-registration/accounting-legal" },
    ...
    },
    {
      ...
      items: [
        ...
        { text: "UAE संस्थाएं तुलना", link: "comparison/entity-types" },
      ],
    },
  ]
}
...
function sidebarInsights(): DefaultTheme.SidebarItem[] {
  return [
    ...
    { text: "AI सेवाओं के लिए कानूनी विनियमन", link: "Legal-Regulations-for-AI-Services" },
  ]
}

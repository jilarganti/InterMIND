...
<FeatureBlock :card="{
  ...
  details: 'يتيح InterMind لكل مشارك التحدث بلغته الأم — بشكل طبيعي، [في الوقت الفعلي](/guide/how-it-works)، وبدون ترجمات مكتوبة أو تأخير.',
    items: [
...
<FeatureBlock :card="{
  ...
  items: [
    ...
    '✧ ملخصات اجتماعات ذكية تقدم النقاط الرئيسية فوراً بأي لغة، مما يحافظ على تناغم الجميع دون تدوين ملاحظات يدوية.',
  ],
...
<FeatureBlock
  :card="{
    ...
    details:
      'InterMind مصمم للمحادثات التي تهم فيها الثقة. بينما نعتمد على أفضل البنية التحتية من الطرف الثالث، [تبقى السرية دائماً في يديك](/guide/privacy-architecture).',
    items: [
...
<PricingPlans :plans="[
  ...
  },
  {
    ...
    price: '**20 دولار** شهرياً/مستخدم، يُدفع سنوياً',
    details: 'أو 13.99 دولار شهرياً',
    items: [
  ...
  },
  {
    ...
    price: 'خطة **مخصصة** للفرق الكبيرة',
    details: 'مُحسّنة للتوسع والخصوصية والتحكم',
    items: [
...
<AuthButton text="جرّب مجاناً" buttonClass="alt"/>
...
<AccordionGroup :items="[
  ...
  },
  {
      ...
      a: 'يعتمد عدد المشاركين على خطتك: الخطة الأساسية تسمح بما يصل إلى 100 مشارك، وخطة Pro تدعم حتى 150 مشاركاً، وخطة Business تستوعب حتى 500 مشارك في كل اجتماع.'
  },
  {

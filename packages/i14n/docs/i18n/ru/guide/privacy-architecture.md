# Регионально-сегментированная архитектура конфиденциальности от InterMind
...
| Регион        | Применимые законы                                                                             | Инфраструктура                | Поставщики LLM             |
| ------------- | -------------------------------------------------------------------------------------------- | ----------------------------- | -------------------------- |
| Европа        | [GDPR](https://gdpr.eu)                                                                       | Только дата-центры ЕС         | Размещенные в ЕС или соответствующие требованиям ЕС |
| США           | [CCPA](https://oag.ca.gov/privacy/ccpa)                                                       | AWS / GCP / Azure (US)        | OpenAI US / Anthropic US   |
...
Клиентские функции, такие как захват речи и отображение интерфейса, обрабатываются локально, когда это возможно.
...
- Что облачные хостинги не имеют доступа к медиа, передаваемым через их системы (если вы не используете защищенный анклав или корпоративное развертывание).

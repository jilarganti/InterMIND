...
var _DeleteStageResponseData = _interopRequireDefault(require("./DeleteStageResponseData"));
/**
 * Pipedrive API v1
...
var DeleteStageResponse = /*#__PURE__*/function () {
   ...
   */
  (0, _createClass2["default"])(DeleteStageResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DeleteStageResponseData["default"].constructFromObject(data['data']);
          delete data['data'];
        }
...
var _default = DeleteStageResponse;

...
const __pageData = JSON.parse('{"title":"यूएई कॉर्पोरेट बैंकिंग | सफलता शुल्क आधारित सेवा","description":"बिना अग्रिम शुल्क के प्रीमियम मल्टी-करेंसी कॉर्पोरेट खाते - केवल स्वीकृति के बाद भुगतान करें। 96% सफलता दर के साथ पूर्ण आवेदन प्रबंधन। गारंटीड खाता खोलना।","frontmatter":{"layout":"home","title":"यूएई कॉर्पोरेट बैंकिंग | सफलता शुल्क आधारित सेवा","description":"बिना अग्रिम शुल्क के प्रीमियम मल्टी-करेंसी कॉर्पोरेट खाते - केवल स्वीकृति के बाद भुगतान करें। 96% सफलता दर के साथ पूर्ण आवेदन प्रबंधन। गारंटीड खाता खोलना।","showSponsors":false,"hero":{"name":"यूएई बैंकिंग: आपका सुरक्षित आश्रय","tagline":"2025 में गारंटीड कॉर्पोरेट बैंक खाता स्वीकृति। <span class=\\"hl\\">बिना अग्रिम शुल्क</span> - केवल स्वीकृति के बाद भुगतान करें। 96% सफलता दर।","image":{"light":{"src":"/img/Logo.avif","width":"40%"},"dark":{"src":"/img/Logo.avif","width":"40%"},"alt":"Golden Fish लोगो"}},"head":[["meta",{"name":"robots","content":"noindex"}]]},"headers":[],"params":{},"relativePath":"hi/uae-business/offer/banking/index.md","filePath":"i18n/hi/uae-business/offer/banking/index.md","lastUpdated":1743682283000}');
const _sfc_main = { name: "hi/uae-business/offer/banking/index.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<h2 id="golden-fish-अपने-ग्राहकों-को-इन-बैंकों-की-सिफारिश-करता-है" tabindex="-1">Golden Fish अपने ग्राहकों को इन बैंकों की सिफारिश करता है: <a class="header-anchor" href="#golden-fish-अपने-ग्राहकों-को-इन-बैंकों-की-सिफारिश-करता-है" aria-label="Permalink to &quot;Golden Fish अपने ग्राहकों को इन बैंकों की सिफारिश करता है:&quot;">​</a></h2>`);
  ...
  _push(`<h2 id="अपनी-कॉर्पोरेट-बैंकिंग-आवश्यकताओं-पर-चर्चा-करने-के-लिए-निःशुल्क-परामर्श-बुक-करें" tabindex="-1">अपनी कॉर्पोरेट बैंकिंग आवश्यकताओं पर चर्चा करने के लिए निःशुल्क परामर्श बुक करें <a class="header-anchor" href="#अपनी-कॉर्पोरेट-बैंकिंग-आवश्यकताओं-पर-चर्चा-करने-के-लिए-निःशुल्क-परामर्श-बुक-करें" aria-label="Permalink to &quot;अपनी कॉर्पोरेट बैंकिंग आवश्यकताओं पर चर्चा करने के लिए निःशुल्क परामर्श बुक करें&quot;">​</a></h2><video autoplay muted playsinline style="${ssrRenderStyle({ "padding": "80px" })}"><source${ssrRenderAttr("src", _imports_0)} type="video/mp4"></video>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("i18n/hi/uae-business/offer/banking/index.md");

...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{"head":[["meta",{"name":"robots","content":"noindex"}]]},"headers":[],"params":{},"relativePath":"uae-business/include/recommended-banks.md","filePath":"en/uae-business/include/recommended-banks.md","lastUpdated":1740637442000}');
const _sfc_main = { name: "uae-business/include/recommended-banks.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("en/uae-business/include/recommended-banks.md");

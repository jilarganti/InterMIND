...
const __pageData = JSON.parse(`{"title":"Бизнес в ОАЭ без риска | Нет одобрения - нет оплаты","description":"Революционная модель создания компании в ОАЭ: оплата только после успеха. Экспертное сопровождение на каждом этапе с успешностью более 90%.","frontmatter":{"layout":"home","title":"Бизнес в ОАЭ без риска | Нет одобрения - нет оплаты","description":"Революционная модель создания компании в ОАЭ: оплата только после успеха. Экспертное сопровождение на каждом этапе с успешностью более 90%.","showSponsors":false,"hero":{"name":"Регистрация компании в ОАЭ: мы разделяем ваш риск","tagline":"Инвестируйте в свой бизнес уверенно: мы получаем оплату только после успешной регистрации компании. <span class='hl'>Ваш успех - наша единственная цель</span>.","image":{"light":{"src":"/img/Logo.avif","width":"40%"},"dark":{"src":"/img/Logo.avif","width":"40%"},"alt":"Логотип Golden Fish"}},"head":[["meta",{"name":"robots","content":"noindex"}]]},"headers":[],"params":{},"relativePath":"ru/uae-business/offer/company-registration/index.md","filePath":"i18n/ru/uae-business/offer/company-registration/index.md","lastUpdated":1743693225000}`);
const _sfc_main = { name: "ru/uae-business/offer/company-registration/index.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<h2 id="запишитесь-на-бесплатную-консультацию-чтобы-проверить-вашу-правомочность-и-обсудить-возможные-варианты" tabindex="-1">Запишитесь на бесплатную консультацию, чтобы проверить вашу правомочность и обсудить возможные варианты. <a class="header-anchor" href="#запишитесь-на-бесплатную-консультацию-чтобы-проверить-вашу-правомочность-и-обсудить-возможные-варианты" aria-label="Permalink to &quot;Запишитесь на бесплатную консультацию, чтобы проверить вашу правомочность и обсудить возможные варианты.&quot;">​</a></h2><video autoplay muted playsinline style="${ssrRenderStyle({ "padding": "80px" })}"><source${ssrRenderAttr("src", _imports_0)} type="video/mp4"></video>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("i18n/ru/uae-business/offer/company-registration/index.md");

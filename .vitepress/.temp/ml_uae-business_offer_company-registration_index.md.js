...
const __pageData = JSON.parse(`{"title":"റിസ്ക് ഇല്ലാതെ UAE ബിസിനസ് | അംഗീകാരം ഇല്ലെങ്കിൽ പണം നൽകേണ്ടതില്ല","description":"വിപ്ലവകരമായ UAE കമ്പനി രൂപീകരണ മോഡൽ: വിജയത്തിന് ശേഷം മാത്രം നിങ്ങൾ പണം നൽകുക. 90%+ വിജയ നിരക്കോടെ എല്ലാ ഘട്ടങ്ങളിലും വിദഗ്ധ മാർഗനിർദ്ദേശം.","frontmatter":{"layout":"home","title":"റിസ്ക് ഇല്ലാതെ UAE ബിസിനസ് | അംഗീകാരം ഇല്ലെങ്കിൽ പണം നൽകേണ്ടതില്ല","description":"വിപ്ലവകരമായ UAE കമ്പനി രൂപീകരണ മോഡൽ: വിജയത്തിന് ശേഷം മാത്രം നിങ്ങൾ പണം നൽകുക. 90%+ വിജയ നിരക്കോടെ എല്ലാ ഘട്ടങ്ങളിലും വിദഗ്ധ മാർഗനിർദ്ദേശം.","showSponsors":false,"hero":{"name":"UAE കമ്പനി രൂപീകരണം: ഞങ്ങൾ നിങ്ങളുടെ റിസ്ക് പങ്കിടുന്നു","tagline":"ആത്മവിശ്വാസത്തോടെ നിങ്ങളുടെ ബിസിനസ്സിൽ നിക്ഷേപിക്കുക: കമ്പനി രജിസ്ട്രേഷൻ വിജയകരമായി പൂർത്തിയാക്കിയ ശേഷം മാത്രമേ ഞങ്ങൾക്ക് പണം ലഭിക്കൂ. <span class='hl'>നിങ്ങളുടെ വിജയം മാത്രമാണ് ഞങ്ങളുടെ ലക്ഷ്യം</span>.","image":{"light":{"src":"/img/Logo.avif","width":"40%"},"dark":{"src":"/img/Logo.avif","width":"40%"},"alt":"Golden Fish ലോഗോ"}},"head":[["meta",{"name":"robots","content":"noindex"}]]},"headers":[],"params":{},"relativePath":"ml/uae-business/offer/company-registration/index.md","filePath":"i18n/ml/uae-business/offer/company-registration/index.md","lastUpdated":1743693225000}`);
const _sfc_main = { name: "ml/uae-business/offer/company-registration/index.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("i18n/ml/uae-business/offer/company-registration/index.md");

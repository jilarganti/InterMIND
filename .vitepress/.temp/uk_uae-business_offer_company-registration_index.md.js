...
const __pageData = JSON.parse(`{"title":"Бізнес в ОАЕ без ризику | Немає схвалення - немає оплати","description":"Революційна модель створення компанії в ОАЕ: оплата тільки після успіху. Експертний супровід на кожному етапі з показником успіху понад 90%.","frontmatter":{"layout":"home","title":"Бізнес в ОАЕ без ризику | Немає схвалення - немає оплати","description":"Революційна модель створення компанії в ОАЕ: оплата тільки після успіху. Експертний супровід на кожному етапі з показником успіху понад 90%.","showSponsors":false,"hero":{"name":"Реєстрація компанії в ОАЕ: Ми розділяємо ваш ризик","tagline":"Інвестуйте у свій бізнес впевнено: ми отримуємо оплату тільки після успішної реєстрації компанії. <span class='hl'>Ваш успіх - наша єдина мета</span>.","image":{"light":{"src":"/img/Logo.avif","width":"40%"},"dark":{"src":"/img/Logo.avif","width":"40%"},"alt":"Логотип Golden Fish"}},"head":[["meta",{"name":"robots","content":"noindex"}]]},"headers":[],"params":{},"relativePath":"uk/uae-business/offer/company-registration/index.md","filePath":"i18n/uk/uae-business/offer/company-registration/index.md","lastUpdated":1743693601000}`);
const _sfc_main = { name: "uk/uae-business/offer/company-registration/index.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<h2 id="забронюите-безкоштовну-консультацію-щоб-перевірити-вашу-відповідність-вимогам-та-обговорити-варіанти" tabindex="-1">Забронюйте безкоштовну консультацію, щоб перевірити вашу відповідність вимогам та обговорити варіанти. <a class="header-anchor" href="#забронюите-безкоштовну-консультацію-щоб-перевірити-вашу-відповідність-вимогам-та-обговорити-варіанти" aria-label="Permalink to &quot;Забронюйте безкоштовну консультацію, щоб перевірити вашу відповідність вимогам та обговорити варіанти.&quot;">​</a></h2><video autoplay muted playsinline style="${ssrRenderStyle({ "padding": "80px" })}"><source${ssrRenderAttr("src", _imports_0)} type="video/mp4"></video>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("i18n/uk/uae-business/offer/company-registration/index.md");

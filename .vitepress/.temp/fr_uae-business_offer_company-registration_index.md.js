...
const __pageData = JSON.parse(`{"title":"Entreprise aux EAU Sans Risque | Pas d'Approbation, Pas de Paiement","description":"Modèle révolutionnaire de création d'entreprise aux EAU : vous ne payez qu'après le succès. Accompagnement expert à chaque étape avec un taux de réussite de 90%+","frontmatter":{"layout":"home","title":"Entreprise aux EAU Sans Risque | Pas d'Approbation, Pas de Paiement","description":"Modèle révolutionnaire de création d'entreprise aux EAU : vous ne payez qu'après le succès. Accompagnement expert à chaque étape avec un taux de réussite de 90%+","showSponsors":false,"hero":{"name":"Création d'Entreprise aux EAU : Nous Partageons Votre Risque","tagline":"Investissez dans votre entreprise en toute confiance : nous ne sommes payés qu'après l'enregistrement réussi de votre société. <span class='hl'>Votre succès est notre seul objectif</span>.","image":{"light":{"src":"/img/Logo.avif","width":"40%"},"dark":{"src":"/img/Logo.avif","width":"40%"},"alt":"Logo Golden Fish"}},"head":[["meta",{"name":"robots","content":"noindex"}]]},"headers":[],"params":{},"relativePath":"fr/uae-business/offer/company-registration/index.md","filePath":"i18n/fr/uae-business/offer/company-registration/index.md","lastUpdated":1743693225000}`);
const _sfc_main = { name: "fr/uae-business/offer/company-registration/index.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<h2 id="reservez-une-consultation-gratuite-pour-verifier-votre-eligibilite-et-discuter-de-vos-options" tabindex="-1">Réservez une consultation gratuite pour vérifier votre éligibilité et discuter de vos options. <a class="header-anchor" href="#reservez-une-consultation-gratuite-pour-verifier-votre-eligibilite-et-discuter-de-vos-options" aria-label="Permalink to &quot;Réservez une consultation gratuite pour vérifier votre éligibilité et discuter de vos options.&quot;">​</a></h2><video autoplay muted playsinline style="${ssrRenderStyle({ "padding": "80px" })}"><source${ssrRenderAttr("src", _imports_0)} type="video/mp4"></video>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("i18n/fr/uae-business/offer/company-registration/index.md");

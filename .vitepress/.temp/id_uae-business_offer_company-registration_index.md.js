...
const __pageData = JSON.parse(`{"title":"Bisnis UAE Tanpa Risiko | Tanpa Persetujuan, Tanpa Pembayaran","description":"Model pembentukan perusahaan UAE revolusioner: Anda hanya membayar setelah berhasil. Panduan ahli di setiap tahap dengan tingkat keberhasilan 90%+.","frontmatter":{"layout":"home","title":"Bisnis UAE Tanpa Risiko | Tanpa Persetujuan, Tanpa Pembayaran","description":"Model pembentukan perusahaan UAE revolusioner: Anda hanya membayar setelah berhasil. Panduan ahli di setiap tahap dengan tingkat keberhasilan 90%+.","showSponsors":false,"hero":{"name":"Pembentukan Perusahaan UAE: Kami Berbagi Risiko Anda","tagline":"Investasikan bisnis Anda dengan percaya diri: kami hanya dibayar setelah pendaftaran perusahaan berhasil. <span class='hl'>Kesuksesan Anda adalah satu-satunya tujuan kami</span>.","image":{"light":{"src":"/img/Logo.avif","width":"40%"},"dark":{"src":"/img/Logo.avif","width":"40%"},"alt":"Logo Golden Fish"}},"head":[["meta",{"name":"robots","content":"noindex"}]]},"headers":[],"params":{},"relativePath":"id/uae-business/offer/company-registration/index.md","filePath":"i18n/id/uae-business/offer/company-registration/index.md","lastUpdated":1743693225000}`);
const _sfc_main = { name: "id/uae-business/offer/company-registration/index.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<h2 id="mengapa-memilih-golden-fish" tabindex="-1">Mengapa Memilih Golden Fish <a class="header-anchor" href="#mengapa-memilih-golden-fish" aria-label="Permalink to &quot;Mengapa Memilih Golden Fish&quot;">​</a></h2>`);
  ...
  _push(`<h2 id="pesan-konsultasi-gratis-untuk-memeriksa-kelayakan-dan-mendiskusikan-pilihan-anda" tabindex="-1">Pesan konsultasi gratis untuk memeriksa kelayakan dan mendiskusikan pilihan Anda. <a class="header-anchor" href="#pesan-konsultasi-gratis-untuk-memeriksa-kelayakan-dan-mendiskusikan-pilihan-anda" aria-label="Permalink to &quot;Pesan konsultasi gratis untuk memeriksa kelayakan dan mendiskusikan pilihan Anda.&quot;">​</a></h2><video autoplay muted playsinline style="${ssrRenderStyle({ "padding": "80px" })}"><source${ssrRenderAttr("src", _imports_0)} type="video/mp4"></video>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("i18n/id/uae-business/offer/company-registration/index.md");

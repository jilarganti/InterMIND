...
hero:
  ...
  tagline: ضمان فتح حسابات مصرفية للشركات في 2025. <span class="hl">بدون رسوم مقدمة</span> - ادفع فقط بعد الموافقة. معدل نجاح 96٪.
  image:
    light:
      src: /img/Logo.avif
      width: 40%
...
<ContactFormModal 
  ...
  :services="[
  'أساسي — استشارة أساسية للمستندات وفتح الحساب فقط',
  'قياسي — مستندات كاملة وتوجيه خلال جميع المراحل المصرفية',

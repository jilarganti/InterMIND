...
<BenefitsList :features="[
  ...
  },
  {
    ...
    text: '98% успешных заявок с сотнями выданных Golden Visa через наш премиальный сервис.'
  },
  {
    icon: '📋',
    title: 'Полное сопровождение',
    text: 'Комплексное ведение от подготовки документов до получения визы, забота обо всех деталях.'
  },
  {
    icon: '👨‍💼',
  ...
  {
    icon: '🔄',
    title: 'Поддержка продления',
    text: 'Бесплатная помощь в продлении визы **без комиссии агентства** - только государственные сборы.'
  }
]" />
...
<ContactFormModal formName="Golden Visa [offer]" buttonText="Получить бесплатную консультацию" :services="[
  '🏠 Инвестиции в недвижимость ОАЭ от 2 млн дирхамов',
  '💰 Вклад в инвестиционные фонды ОАЭ от 2 млн дирхамов',
  '🏢 Бизнес с капиталом от 2 млн дирхамов',
  '📈 Ежегодный взнос в FTA от 250 тыс. дирхамов',
  '👨‍💼 Квалифицированные специалисты',
  '🎯 Выдающиеся таланты',]"/>

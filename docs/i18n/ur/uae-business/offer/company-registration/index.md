...
<FeatureBlock :card="{
  ...
  details: 'متحدہ عرب امارات کے متعدد فوائد کے باوجود، کاروباری اداروں کو کاروبار قائم کرتے وقت ممکنہ چیلنجز سے آگاہ ہونا چاہیے۔ \n\n* پیچیدہ ریگولیٹری ماحول: مختلف امارات اور فری زونز میں مختلف قوانین\n* اقتصادی مواد کی ضروریات: مخصوص سرگرمیوں کے لیے مقامی عملہ اور دفتر کی جگہ کی ضرورت\n* ابتدائی اخراجات زیادہ: رجسٹریشن فیس، دستاویزات، اور لازمی دفتر کا کرایہ\n\n[مکمل فہرست دیکھیں](/uae-business/company-registration/benefits-problems#disadvantages-of-doing-business-in-the-uae)',

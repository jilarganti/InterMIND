...
<BenefitsList :features="[
  ...
  },
  {
    ...
    text: 'আমাদের প্রিমিয়াম প্রক্রিয়াকরণের মাধ্যমে শতাধিক ভিসা, ব্যাংক অ্যাকাউন্ট এবং কোম্পানি রেজিস্ট্রেশন ইস্যু করা হয়েছে, যার অনুমোদনের হার ৯০% এর বেশি।[Test](https://imind-meetgenius.vercel.app/)'
  },
  {
    icon: '💸',

...
description: "বিপ্লবী UAE কোম্পানি গঠনের মডেল: সফলতার পরেই শুধু আপনি পেমেন্ট করবেন। প্রতিটি ধাপে বিশেষজ্ঞ গাইডেন্স সহ 90%+ সাফল্যের হার।"
showSponsors: false

hero:
  name: "UAE কোম্পানি গঠন: আমরা আপনার ঝুঁকি ভাগ করি"
  tagline: "মনের শান্তি নিয়ে আপনার ব্যবসা বাড়ান। <span class='hl'>অনুমোদন না হওয়া পর্যন্ত কোন এজেন্ট ফি নেই</span>। ফলাফল না পাওয়া পর্যন্ত আমরা পেমেন্ট নিই না।"
  image:
    light:
      src: /img/Logo.avif
      width: 40%
...
<FeatureCards :features="[
  ...
  },
  {
    ...
    items: [
      ...
      'যোগ্যতার শর্তাবলী বজায় রেখে 10 বছরের বৈধতা সহ নবায়নের সুযোগ',
      '92% সাফল্যের হার'
    ],
    linkText: 'আরও জানুন',
